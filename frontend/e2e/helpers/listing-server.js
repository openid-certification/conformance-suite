 ...
 * paging, so a spec can assert what a page of `/api/log` or `/api/plan` shows
 * rather than only which URL was requested.
 *
 * TWIN: `frontend/stories/fixtures/listing-server.js` is the same function for
 * the Storybook MSW handlers; keep the two in step.
 *
