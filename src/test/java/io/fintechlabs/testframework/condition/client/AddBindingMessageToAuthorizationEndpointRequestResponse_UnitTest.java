...
public class AddBindingMessageToAuthorizationEndpointRequestResponse_UnitTest {
	...
	private AddBindingMessageToAuthorizationEndpointRequestResponse cond;

	@Before
	public void setUp() throws Exception {
		cond = new AddBindingMessageToAuthorizationEndpointRequestResponse("UNIT-TEST", eventLog, Condition.ConditionResult.INFO);
	}
