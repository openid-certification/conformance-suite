...
public class SetClientAuthenticationAudToTokenEndpoint_UnitTest {
	...
	private SetClientAuthenticationAudToTokenEndpoint cond;
	...
	public void setUp() throws Exception {
		...
		cond = new SetClientAuthenticationAudToTokenEndpoint("UNIT-TEST", eventLog, ConditionResult.INFO);
