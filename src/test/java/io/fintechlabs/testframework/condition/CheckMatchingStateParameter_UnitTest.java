...
public class CheckMatchingStateParameter_UnitTest {
	...
	public void setUp() throws Exception {
		...
		cond = new CheckMatchingStateParameter("UNIT-TEST", eventLog, false);
	...
	/**
	 * Test method for {@link io.fintechlabs.testframework.condition.CheckMatchingStateParameter#evaluate(io.fintechlabs.testframework.testmodule.Environment)}.
	 */
	@Test
