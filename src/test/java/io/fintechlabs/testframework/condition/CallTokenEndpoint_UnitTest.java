...
public class CallTokenEndpoint_UnitTest {
	...
	public void setUp() throws Exception {
		...
		cond = new CallTokenEndpoint("UNIT-TEST", eventLog, false);
	}
	
	/**
	 * Test method for {@link io.fintechlabs.testframework.condition.CallTokenEndpoint#evaluate(io.fintechlabs.testframework.testmodule.Environment)}.
	 */
	@Test
