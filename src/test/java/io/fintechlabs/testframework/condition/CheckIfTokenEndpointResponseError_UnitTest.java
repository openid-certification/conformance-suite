...
public class CheckIfTokenEndpointResponseError_UnitTest {
	...
	public void setUp() throws Exception {
		...
		cond = new CheckIfTokenEndpointResponseError("UNIT-TEST", eventLog, false);
	...
	/**
	 * Test method for {@link io.fintechlabs.testframework.condition.CheckIfTokenEndpointResponseError#evaluate(io.fintechlabs.testframework.testmodule.Environment)}.
	 */
