...
public class CheckForAccessTokenValue_UnitTest {
	...
	public void setUp() throws Exception {
		...
		cond = new CheckForAccessTokenValue("UNIT-TEST", eventLog, false);
	...
	/**
	 * Test method for {@link io.fintechlabs.testframework.condition.CheckForAccessTokenValue#evaluate(io.fintechlabs.testframework.testmodule.Environment)}.
	 */
	@Test
