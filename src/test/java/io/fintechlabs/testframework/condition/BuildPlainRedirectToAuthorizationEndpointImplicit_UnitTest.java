...
public class BuildPlainRedirectToAuthorizationEndpointImplicit_UnitTest {
	...
	private BuildPlainRedirectToAuthorizationEndpointImplicit cond;
	...
	public void setUp() throws Exception {
		...
		cond = new BuildPlainRedirectToAuthorizationEndpointImplicit("UNIT-TEST", eventLog, false);
	...
	public void testEvaluate() {
		...
		assertThat(redirectUriParams.get("response_type")).containsExactly("token");
