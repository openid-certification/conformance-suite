...
public class CheckIfAuthorizationEndpointError_UnitTest {
	...
	public void setUp() throws Exception {
		...
		cond = new CheckIfAuthorizationEndpointError("UNIT-TEST", eventLog, false);
	...
	/**
	 * Test method for {@link io.fintechlabs.testframework.condition.CheckIfAuthorizationEndpointError#evaluate(io.fintechlabs.testframework.testmodule.Environment)}.
	 */
	@Test
