...
class EnsureValidSubjectSearchResponse_UnitTest {
	...
	private EnsureValidSubjectSearchResponse cond;

	@BeforeEach
	public void setUp() {
		cond = new EnsureValidSubjectSearchResponse();
	...
	public void requestWithoutType_throws() {
		...
		assertTrue(e.getMessage().contains("No subject type"));
	}
	...
	public void resultsWithDifferentRequestedType_throws() {
		...
		Throwable e = assertThrows(ConditionError.class, () -> cond.execute(env));
		assertTrue(e.getMessage().contains("does not contain the requested subject type"));
	}
