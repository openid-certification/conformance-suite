...
public class OIDSSFWarnNonStandardCaepCredentialChangeValues_UnitTest {
	...
	private OIDSSFWarnNonStandardCaepCredentialChangeValues condition;

	@BeforeEach
	public void setUp() {
		condition = new OIDSSFWarnNonStandardCaepCredentialChangeValues();
	...
	@Test
	void shouldPassWithStandardValues() {
	...
	@Test
	void shouldPassWhenFieldsAreMissing() {
		// Missing fields are handled by OIDSSFValidateCaepCredentialChangeEvent, not this condition
