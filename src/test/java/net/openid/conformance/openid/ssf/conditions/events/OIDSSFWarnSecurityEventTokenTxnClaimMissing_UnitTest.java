...
public class OIDSSFWarnSecurityEventTokenTxnClaimMissing_UnitTest {
	...
	private OIDSSFWarnSecurityEventTokenTxnClaimMissing condition;

	@BeforeEach
	public void setUp() {
		condition = new OIDSSFWarnSecurityEventTokenTxnClaimMissing();
	...
	@Test
	void shouldLeaveTheValueToTheTypeCheck() {
		setUpSetToken(JsonParser.parseString("8675309"));
		assertDoesNotThrow(() -> condition.execute(env));
	}
}
