...
public class ValidateVerifiedClaimsInUserinfoResponseAgainstRequest_UnitTest {
	...
	@Test
	public void testEvaluateExpectedEvidence_multiCheckDetails_noError() throws Exception {
		String requestJson = """
		{
			"claims": {
				"birthdate": null
				...
				"evidence": [
					{
						...
						"check_details": [
							{
								"check_method": "checkMethod3",
								"organization": "myorg2",
								"check_id": "mycheckid2",
								"time": "2022-12-12T00:30Z"
							},
							{
								"check_method": "checkMethod4",
								"organization": "myorg1",
								"check_id": "mycheckid1",
								"time": "2022-12-12T00:30Z"
							}
