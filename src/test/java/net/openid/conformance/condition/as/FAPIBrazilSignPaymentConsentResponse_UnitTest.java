...
public class FAPIBrazilSignPaymentConsentResponse_UnitTest {
	...
	private FAPIBrazilSignPaymentConsentResponse cond;
	...
	public void setUp() throws Exception {
		cond = new FAPIBrazilSignPaymentConsentResponse();
	...
	/**
	 * Test method for {@link FAPIBrazilSignPaymentConsentResponse#evaluate(Environment)}.
	 *
	...
	public void testEvaluate_valuesPresent() throws JOSEException, ParseException {
		...
		env.putObject("consent_response", consentRequestClaimsAudString);

		cond.execute(env);

		verify(env, atLeastOnce()).getObject("consent_response");

		String consentObjectString = env.getString("signed_consent_response");
	...
	public void testEvaluate_audAsArray() throws JOSEException, ParseException {
		env.putObject("server_jwks", jwks);
		env.putObject("consent_response", consentRequestClaimsAudArray);
