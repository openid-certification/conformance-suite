...
public class ValidateClientAssertionAudClaimIsIssuerAsString_UnitTest {
	...
	private ValidateClientAssertionAudClaimIsIssuerAsString cond;

	@BeforeEach
	public void setUp() throws Exception {

		cond = new ValidateClientAssertionAudClaimIsIssuerAsString();
