...
public class AddFAPIInteractionIdToTokenEndpointRequest_UnitTest {
	...
	private AddFAPIInteractionIdToTokenEndpointRequest cond;
	...
	public void setUp() throws Exception {
		cond = new AddFAPIInteractionIdToTokenEndpointRequest();
	...
	public void testEvaluate() {
		...
		JsonObject req = env.getObject("token_endpoint_request_headers");
	...
	public void testEvaluate_existingHeadersOverwrite() {
		...
		env.putString("fapi_interaction_id", interactionId);
		env.putObject("token_endpoint_request_headers",	JsonParser.parseString("{\"x-fapi-interaction-id\":\"foo-bar\"}").getAsJsonObject());
