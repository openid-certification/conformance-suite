...
public class SetClientAssertionTypeToWrongValue_UnitTest {
	...
	private SetClientAssertionTypeToWrongValue cond;

	@BeforeEach
	public void setUp() throws Exception {
		cond = new SetClientAssertionTypeToWrongValue();
		cond.setProperties("UNIT-TEST", eventLog, ConditionResult.INFO);
	}

	@Test
	public void testEvaluate_replacesTheType() {
		...
		assertThat(env.getString("request_form_parameters", "client_assertion_type"))
			.isNotEqualTo("urn:ietf:params:oauth:client-assertion-type:jwt-bearer")
			.isNotBlank();
		assertThat(result.has("client_assertion")).isTrue();
	}
