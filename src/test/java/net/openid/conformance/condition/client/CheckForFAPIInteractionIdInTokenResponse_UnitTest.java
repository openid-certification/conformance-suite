...
public class CheckForFAPIInteractionIdInTokenResponse_UnitTest {
	...
	private CheckForFAPIInteractionIdInTokenResponse cond;

	@BeforeEach
	public void setUp() throws Exception {
		cond = new CheckForFAPIInteractionIdInTokenResponse();
		cond.setProperties("UNIT-TEST", eventLog, ConditionResult.INFO);
	}

	/**
	 * Test method for {@link CheckForFAPIInteractionIdInTokenResponse#evaluate(Environment)}.
	 */
	@Test
	public void testEvaluate_noError() {
		...
		verify(env, atLeastOnce()).getString("token_endpoint_response_headers", "x-fapi-interaction-id");
	}
