...
public class CheckForFAPIInteractionIdInPARResponse_UnitTest {
	...
	private CheckForFAPIInteractionIdInPARResponse cond;

	@BeforeEach
	public void setUp() throws Exception {
		cond = new CheckForFAPIInteractionIdInPARResponse();
		cond.setProperties("UNIT-TEST", eventLog, ConditionResult.INFO);
	}

	/**
	 * Test method for {@link CheckForFAPIInteractionIdInPARResponse#evaluate(Environment)}.
	 */
	@Test
	public void testEvaluate_noError() {
		...
		env.putObject("pushed_authorization_endpoint_response_headers", headers);

		cond.execute(env);

		verify(env, atLeastOnce()).getString("pushed_authorization_endpoint_response_headers", "x-fapi-interaction-id");
	}
