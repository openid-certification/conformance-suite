 ...
 * table all render one, and each injects this sheet once, so every one of
 * them looks right on a page with none of the others. Spacing stays with the
 * component: where a table sits is its business, what it looks like is not.
 *
...
const STYLE_TEXT = css`
  ...
  /* A wide table scrolls inside this box rather than widening its card or
     ...
     overflow on the disclosure would clip it. */
