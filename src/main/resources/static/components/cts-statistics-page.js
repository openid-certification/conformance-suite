 ...
 * still being served.
 *
 * Color is an identity here: {@link assignFamilySlots} is computed once
...
class CtsStatisticsPage extends LitElement {
  ...
  constructor() {
    ...
    /** @type {Record<string, string>} Family → color token, from the FULL payload. */
    this._slots = {};
  ...
  _apply(response, body) {
    ...
    // From the FULL payload, never the slice — a family keeps its color
