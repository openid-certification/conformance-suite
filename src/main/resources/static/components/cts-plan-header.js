          ...
          <div class="row" id="planHeader">
            <div class="col-md-12">
              ...
              ${plan.certificationProfileName
                ? html`
                  <div class="row" data-testid="certification-row">
              ...
              <div class="row top10">
                <div class="col-md-12">
                  These test results were generated by the OpenID Foundation conformance suite.
                  By themselves, they are not proof that a deployment is conformant nor that it
                  meets the requirements for certification. For a list of certified deployments,
                  see <a href="https://openid.net/certification/">https://openid.net/certification/</a>
