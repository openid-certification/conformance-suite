...
export class CtsPrivateLinkDialog extends LitElement {
   ...
   */
  async _handleCopy(e) {
    const trigger = /** @type {Element | null} */ (e ? e.currentTarget : null);
  ...
  render() {
    ...
    return html`
      <cts-modal ${ref(this._modalRef)} heading="Private link" data-testid="private-link-dialog">
        ...
        ${this._error
          ? html`<cts-alert variant="danger" style="margin-top: var(--space-3);"
