 ...
 * together on the one page that uses either, and share the section heading
 * and the small print under a table so a change to the type scale reaches
 * both. Spacing stays with the component: where a heading or a hint sits is
 * its business, what it looks like is not.
 *
