...
@PublishTestModule(
	testName = "fapi-rw-client-test-code-id-token-with-matls-invalid-chash",
	displayName = "FAPI-RW: client test - invalid c_hash in id_token from authorization_endpoint should be rejected (code id_token with MTLS)",
...
public class FAPIRWClientTestCodeIdTokenWithMATLSInvalidCHash extends AbstractFAPIRWClientExpectNothingAfterAuthorisationEndpoint {
