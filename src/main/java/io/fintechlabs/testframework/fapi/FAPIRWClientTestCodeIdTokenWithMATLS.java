...
@PublishTestModule(
	testName = "fapi-rw-client-test-code-id-token-with-matls",
	displayName = "FAPI-RW: client test (code id_token)",
...
public class FAPIRWClientTestCodeIdTokenWithMATLS extends AbstractFAPIRWClientTestCodeIdToken {
