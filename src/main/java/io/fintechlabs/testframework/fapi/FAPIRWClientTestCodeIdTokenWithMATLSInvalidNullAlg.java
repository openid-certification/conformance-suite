...
@PublishTestModule(
	testName = "fapi-rw-client-test-code-id-token-with-matls-invalid-null-alg",
	displayName = "FAPI-RW: client test - null algorithm used for serialization of id_token from authorization_endpoint, should be rejected (code id_token with MTLS)",
