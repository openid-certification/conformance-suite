...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-signed-by-other-client-fails",
	displayName = "FAPI-CIBA: Ensure request_object signed by other client fails",
...
public class FAPICIBAEnsureRequestObjectSignedByOtherClientFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
