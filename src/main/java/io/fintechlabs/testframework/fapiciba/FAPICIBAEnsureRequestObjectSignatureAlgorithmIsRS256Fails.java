...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-signature-algorithm-is-RS256-fails",
	displayName = "FAPI-CIBA: Ensure request_object signature algorithm is RS256 fails",
...
public class FAPICIBAEnsureRequestObjectSignatureAlgorithmIsRS256Fails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
