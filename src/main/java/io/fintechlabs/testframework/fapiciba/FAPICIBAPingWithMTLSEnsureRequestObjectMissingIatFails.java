...
@PublishTestModule(
	testName = "fapi-ciba-ping-with-mtls-ensure-request-object-missing-iat-fails",
	displayName = "FAPI-CIBA: Ping mode - missing 'iat' value in request object, should return an error (MTLS client authentication)",
