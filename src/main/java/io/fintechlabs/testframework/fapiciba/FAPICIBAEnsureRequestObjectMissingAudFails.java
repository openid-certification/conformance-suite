...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-missing-aud-fails",
	displayName = "FAPI-CIBA: Missing aud value in request object, should return an error",
...
public class FAPICIBAEnsureRequestObjectMissingAudFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
