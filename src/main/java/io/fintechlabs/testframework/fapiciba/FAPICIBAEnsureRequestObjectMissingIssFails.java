...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-missing-iss-fails",
	displayName = "FAPI-CIBA: Missing 'iss' value in request object, should return an error",
...
public class FAPICIBAEnsureRequestObjectMissingIssFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
