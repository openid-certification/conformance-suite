...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-bad-iss-fails",
	displayName = "FAPI-CIBA: Bad 'iss' value in request object, should return an error",
...
public class FAPICIBAEnsureRequestObjectBadIssFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
