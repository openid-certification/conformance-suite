...
@PublishTestModule(
	testName = "fapi-ciba-ping-with-mtls-ensure-request-object-missing-exp-fails",
	displayName = "FAPI-CIBA: Ping mode - missing 'exp' value in request object, should return an error (MTLS client authentication)",
