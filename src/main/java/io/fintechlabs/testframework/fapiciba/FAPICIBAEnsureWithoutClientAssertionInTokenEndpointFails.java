...
@PublishTestModule(
	testName = "fapi-ciba-ensure-without-client-assertion-in-token-endpoint-request",
	displayName = "FAPI-CIBA: Ensure without client_assertion in token endpoint request",
