...
@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-missing-exp-fails",
	displayName = "FAPI-CIBA: Missing 'exp' value in request object, should return an error",
...
public class FAPICIBAEnsureRequestObjectMissingExpFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
