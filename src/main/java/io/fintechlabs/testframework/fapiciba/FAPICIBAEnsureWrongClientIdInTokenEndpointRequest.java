...
@PublishTestModule(
	testName = "fapi-ciba-ensure-wrong-client-id-in-token-endpoint-request",
	displayName = "FAPI-CIBA: Ensure wrong client_id in token endpoint request",
...
public class FAPICIBAEnsureWrongClientIdInTokenEndpointRequest extends AbstractFAPICIBA {
