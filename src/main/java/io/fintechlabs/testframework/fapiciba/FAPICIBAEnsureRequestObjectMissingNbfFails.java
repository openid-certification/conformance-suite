...
import io.fintechlabs.testframework.condition.client.RemoveNbfFromRequestObject;
import io.fintechlabs.testframework.testmodule.PublishTestModule;
import io.fintechlabs.testframework.testmodule.Variant;

@PublishTestModule(
	testName = "fapi-ciba-ensure-request-object-missing-nbf-fails",
	displayName = "FAPI-CIBA: Missing 'nbf' value in request object, should return an error",
...
public class FAPICIBAEnsureRequestObjectMissingNbfFails extends AbstractFAPICIBAEnsureSendingInvalidBackchannelAuthorisationRequest {
