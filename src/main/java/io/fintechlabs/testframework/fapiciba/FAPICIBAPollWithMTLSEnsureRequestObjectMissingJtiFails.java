...
@PublishTestModule(
	testName = "fapi-ciba-poll-with-mtls-ensure-request-object-missing-jti-fails",
	displayName = "FAPI-CIBA: Poll mode - missing 'jti' value in request object, should return an error (MTLS client authentication)",
...
public class FAPICIBAPollWithMTLSEnsureRequestObjectMissingJtiFails extends AbstractFAPICIBAWithMTLSEnsureRequestObjectFails {
	@Override
