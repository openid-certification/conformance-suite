...
public class SetClientAuthenticationAudToTokenEndpoint extends AbstractCondition {

	public SetClientAuthenticationAudToTokenEndpoint(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
