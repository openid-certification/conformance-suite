...
public class AddClientAssertionToBackchannelAuthenticationEndpoint extends AbstractCondition {
	...
	public AddClientAssertionToBackchannelAuthenticationEndpoint(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
