...
public class EnsureInvalidRequestInvalidRequestObjectOrAccessDeniedError extends AbstractCondition {
	...
	public EnsureInvalidRequestInvalidRequestObjectOrAccessDeniedError(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
