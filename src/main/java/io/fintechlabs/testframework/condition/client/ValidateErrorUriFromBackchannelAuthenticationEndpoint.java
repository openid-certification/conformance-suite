...
public class ValidateErrorUriFromBackchannelAuthenticationEndpoint extends AbstractCondition {

	private static final String ERROR_URI_FIELD_PATTERN_VALID = "[\\x21\\x23-\\x5B\\x5D-\\x7E]+";

	public ValidateErrorUriFromBackchannelAuthenticationEndpoint(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
