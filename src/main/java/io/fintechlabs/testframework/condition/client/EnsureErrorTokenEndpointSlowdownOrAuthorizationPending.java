...
public class EnsureErrorTokenEndpointSlowdownOrAuthorizationPending extends AbstractCondition {
	...
	public EnsureErrorTokenEndpointSlowdownOrAuthorizationPending(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
