...
public class CheckBackchannelAuthenticationEndpointHttpStatus400 extends AbstractCheckBackchannelAuthenticationEndpointHttpStatus {
	...
	public CheckBackchannelAuthenticationEndpointHttpStatus400(String testId, TestInstanceEventLog log, Condition.ConditionResult conditionResultOnFailure, String... requirements) {
