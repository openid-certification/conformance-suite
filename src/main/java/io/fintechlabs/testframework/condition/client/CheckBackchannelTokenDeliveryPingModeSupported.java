...
public class CheckBackchannelTokenDeliveryPingModeSupported extends ValidateJsonArray {
	...
	public CheckBackchannelTokenDeliveryPingModeSupported(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
