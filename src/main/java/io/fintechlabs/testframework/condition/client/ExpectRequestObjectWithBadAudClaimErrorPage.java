...
public class ExpectRequestObjectWithBadAudClaimErrorPage extends AbstractCondition {
	...
	public ExpectRequestObjectWithBadAudClaimErrorPage(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
