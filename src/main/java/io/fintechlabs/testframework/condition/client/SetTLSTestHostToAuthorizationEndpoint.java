...
public class SetTLSTestHostToAuthorizationEndpoint extends AbstractSetTLSTestHost {

	/**
	 * @param testId
	 * @param log
	 */
	public SetTLSTestHostToAuthorizationEndpoint(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
