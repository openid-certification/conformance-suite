...
public class AddAcrValuesScaToAuthorizationEndpointRequest extends AbstractCondition {
	...
	public AddAcrValuesScaToAuthorizationEndpointRequest(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
