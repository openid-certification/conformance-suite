...
public class DetectWhetherErrorResponseIsInQueryOrFragment extends AbstractCondition {
	...
	public DetectWhetherErrorResponseIsInQueryOrFragment(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
