...
public class SetTLSTestHostToUserInfoEndpoint extends AbstractSetTLSTestHost {

	/**
	 * @param testId
	 * @param log
	 */
	public SetTLSTestHostToUserInfoEndpoint(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
