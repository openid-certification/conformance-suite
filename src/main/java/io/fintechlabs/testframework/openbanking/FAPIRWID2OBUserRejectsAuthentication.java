...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-user-rejects-authentication",
	displayName = "FAPI-RW-ID2-OB: user rejects authentication",
...
public class FAPIRWID2OBUserRejectsAuthentication extends AbstractFAPIRWID2UserRejectsAuthentication {
