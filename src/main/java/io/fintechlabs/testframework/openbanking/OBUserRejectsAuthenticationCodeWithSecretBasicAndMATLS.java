...
public class OBUserRejectsAuthenticationCodeWithSecretBasicAndMATLS extends AbstractOBUserRejectsAuthenticationCode {
	...
	public OBUserRejectsAuthenticationCodeWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
