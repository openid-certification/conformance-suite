...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-refresh-token",
	displayName = "FAPI-RW-ID2-OB: obtain an id token using a refresh token",
...
public class FAPIRWID2OBRefreshToken extends AbstractFAPIRWID2RefreshTokenTestModule {
