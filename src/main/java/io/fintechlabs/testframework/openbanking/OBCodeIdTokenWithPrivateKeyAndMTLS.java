...
public class OBCodeIdTokenWithPrivateKeyAndMTLS extends AbstractTestModule {

	private static final Logger logger = LoggerFactory.getLogger(OBCodeIdTokenWithPrivateKeyAndMTLS.class);

	public OBCodeIdTokenWithPrivateKeyAndMTLS() {
		super("ob-code-id-token-with-private-key-and-mtls");
	}
