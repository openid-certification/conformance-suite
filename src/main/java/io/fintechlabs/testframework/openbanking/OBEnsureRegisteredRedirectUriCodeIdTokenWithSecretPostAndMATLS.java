...
public class OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretPostAndMATLS extends AbstractOBEnsureRegisteredRedirectUriCodeIdToken {
	...
	public OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretPostAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
