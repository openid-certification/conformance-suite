...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-matching-key-in-authorization-request",
	displayName = "FAPI-RW-ID2-OB: ensure matching key in authorization request",
...
public class FAPIRWID2OBEnsureMatchingKeyInAuthorizationRequest extends AbstractFAPIRWID2EnsureMatchingKeyInAuthorizationRequest {
