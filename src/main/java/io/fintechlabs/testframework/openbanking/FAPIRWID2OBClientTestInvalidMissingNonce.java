...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-invalid-missing-nonce",
	displayName = "FAPI-RW-ID2-OB: client test - missing nonce value in id_token from authorization_endpoint, should be rejected",
...
public class FAPIRWID2OBClientTestInvalidMissingNonce extends AbstractFAPIRWID2OBClientExpectNothingAfterAuthorizationEndpoint {
