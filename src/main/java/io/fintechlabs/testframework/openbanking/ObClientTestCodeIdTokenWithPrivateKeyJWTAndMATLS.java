...
@PublishTestModule(
	testName = "ob-client-test-code-id-token-with-private-key-jwt-and-matls",
	displayName = "OB: client test (code id_token with private_key_jwt and MATLS)",
	profile = "OB",
	configurationFields = {
		"server.jwks",
		"client.client_id",
...
public class ObClientTestCodeIdTokenWithPrivateKeyJWTAndMATLS extends AbstractObClientTestCodeIdToken {
