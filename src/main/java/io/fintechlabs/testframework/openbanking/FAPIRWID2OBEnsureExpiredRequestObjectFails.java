...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-expired-request-object-fails",
	displayName = "FAPI-RW-ID2-OB: ensure expired request object fails",
...
public class FAPIRWID2OBEnsureExpiredRequestObjectFails extends AbstractFAPIRWID2EnsureExpiredRequestObjectFails {
