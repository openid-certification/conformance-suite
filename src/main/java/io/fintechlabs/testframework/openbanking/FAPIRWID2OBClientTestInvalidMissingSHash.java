...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-invalid-missing-shash",
	displayName = "FAPI-RW-ID2-OB: client test - missing s_hash value in id_token from authorization_endpoint, should be rejected",
...
public class FAPIRWID2OBClientTestInvalidMissingSHash extends AbstractFAPIRWID2OBClientExpectNothingAfterAuthorizationEndpoint {
