...
@PublishTestModule(
	...
	displayName = "FAPI-RW-ID2-OB: client test - missing s_hash value in id_token from authorization_endpoint, should be rejected (with private_key_jwt and mtls holder of key)",
