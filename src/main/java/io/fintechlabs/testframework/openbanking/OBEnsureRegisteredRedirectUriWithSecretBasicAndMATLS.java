...
@PublishTestModule(
	testName = "ob-ensure-registered-redirect-uri-with-secret-basic-and-matls",
	displayName = "OB: ensure registered redirect URI (client_secret_basic authentication with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
