...
public class OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdToken {
	...
	public OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdTokenWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
