...
@PublishTestModule(
	testName = "ob-code-with-secret-post-and-matls",
	displayName = "OB: code (client_secret_post authentication with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
...
public class OBCodeWithSecretPostAndMATLS extends AbstractOBServerTestModuleCode {
	...
	public OBCodeWithSecretPostAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
