...
public class OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBEnsureRegisteredRedirectUriCodeIdToken {
	...
	public OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
