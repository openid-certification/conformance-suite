...
@PublishTestModule(
	testName = "ob-ensure-registered-redirect-uri-code-id-token-with-secret-basic-and-matls",
	displayName = "OB: ensure registered redirect URI (code id_token with client_secret_basic authentication and MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
...
public class OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBEnsureRegisteredRedirectUriCodeIdToken {
	...
	public OBEnsureRegisteredRedirectUriCodeIdTokenWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
