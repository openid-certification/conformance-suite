...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-with-private-key-jwt-and-mtls-holder-of-key-invalid-missing-nonce",
	displayName = "FAPI-RW-ID2-OB: client test - missing nonce value in id_token from authorization_endpoint, should be rejected (with private_key_jwt and mtls holder of key)",
...
public class FAPIRWID2OBClientTestWithPrivateKeyJWTAndMTLSHolderOfKeyInvalidMissingNonce extends AbstractFAPIRWID2OBClientPrivateKeyExpectNothingAfterAuthorisationEndpoint {
