...
public abstract class AbstractOBEnsureMATLSRequiredHybridFlow extends AbstractOBServerTestModuleHybridFlow {

	public static Logger logger = LoggerFactory.getLogger(AbstractOBEnsureMATLSRequiredHybridFlow.class);

	public AbstractOBEnsureMATLSRequiredHybridFlow(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
