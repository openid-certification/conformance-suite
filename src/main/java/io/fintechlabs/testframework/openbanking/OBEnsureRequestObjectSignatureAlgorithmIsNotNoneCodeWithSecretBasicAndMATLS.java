...
public class OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeWithSecretBasicAndMATLS extends AbstractOBEnsureRequestObjectSignatureAlgorithmIsNotNoneCode {
	...
	public OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
