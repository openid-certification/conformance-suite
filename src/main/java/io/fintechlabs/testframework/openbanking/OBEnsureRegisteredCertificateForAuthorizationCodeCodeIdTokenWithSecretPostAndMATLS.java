...
public class OBEnsureRegisteredCertificateForAuthorizationCodeCodeIdTokenWithSecretPostAndMATLS extends AbstractOBEnsureRegisteredCertificateForAuthorizationCodeCodeIdToken {
	...
	public OBEnsureRegisteredCertificateForAuthorizationCodeCodeIdTokenWithSecretPostAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
