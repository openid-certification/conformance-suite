...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-with-mtls-holder-of-key-invalid-missing-nonce",
	displayName = "FAPI-RW-ID2-OB: client test - missing nonce value in id_token from authorization_endpoint, should be rejected (with mtls holder of key)",
...
public class FAPIRWID2OBClientTestWithMTLSHolderOfKeyInvalidMissingNonce extends AbstractFAPIRWID2OBClientMTLSHolderOfKeyExpectNothingAfterAuthorisationEndpoint {
