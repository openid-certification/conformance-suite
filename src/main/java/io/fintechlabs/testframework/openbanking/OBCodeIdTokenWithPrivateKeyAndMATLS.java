...
public class OBCodeIdTokenWithPrivateKeyAndMATLS extends AbstractOBServerTestModuleCodeIdToken {
	...
	public OBCodeIdTokenWithPrivateKeyAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
