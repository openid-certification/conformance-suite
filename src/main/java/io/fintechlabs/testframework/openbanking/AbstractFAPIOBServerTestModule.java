...
public abstract class AbstractFAPIOBServerTestModule extends AbstractTestModule {

	private static final Logger logger = LoggerFactory.getLogger(AbstractFAPIOBServerTestModule.class);
