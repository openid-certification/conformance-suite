...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-without-exp-fails",
	displayName = "FAPI-RW-ID2-OB: ensure request object without exp fails",
...
public class FAPIRWID2OBEnsureRequestObjectWithoutExpFails extends AbstractFAPIRWID2EnsureRequestObjectWithoutExpFails {
