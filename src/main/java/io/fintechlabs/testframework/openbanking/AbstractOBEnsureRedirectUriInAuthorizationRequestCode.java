...
public abstract class AbstractOBEnsureRedirectUriInAuthorizationRequestCode extends AbstractOBEnsureRedirectUriInAuthorizationRequest {
	...
	public AbstractOBEnsureRedirectUriInAuthorizationRequestCode(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
