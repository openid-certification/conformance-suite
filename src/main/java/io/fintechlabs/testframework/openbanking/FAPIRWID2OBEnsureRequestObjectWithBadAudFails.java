...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-with-bad-aud-fails",
	displayName = "FAPI-RW-ID2-OB: ensure request object with bad values of aud fails",
...
public class FAPIRWID2OBEnsureRequestObjectWithBadAudFails extends AbstractFAPIRWID2EnsureRequestObjectWithBadAudFails {
