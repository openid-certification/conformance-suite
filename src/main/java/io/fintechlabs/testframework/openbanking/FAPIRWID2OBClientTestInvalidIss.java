...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-invalid-iss",
	displayName = "FAPI-RW-ID2-OB: client test - invalid iss in id_token from authorization_endpoint, should be rejected",
...
public class FAPIRWID2OBClientTestInvalidIss extends AbstractFAPIRWID2ClientExpectNothingAfterAuthorizationEndpoint {
