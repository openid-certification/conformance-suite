...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-signature-algorithm-is-not-none",
	displayName = "FAPI-RW-ID2-OB: ensure request object signature algorithm is not none",
...
public class FAPIRWID2OBEnsureRequestObjectSignatureAlgorithmIsNotNone extends AbstractFAPIRWID2EnsureRequestObjectSignatureAlgorithmIsNotNone {
