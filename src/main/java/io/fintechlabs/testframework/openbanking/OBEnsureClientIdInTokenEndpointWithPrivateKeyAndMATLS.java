...
@PublishTestModule(
	testName = "ob-ensure-wrong-client-id-in-token-endpoint-fails-with-private-key-and-matls",
	displayName = "OB: ensure client id in token endpoint fails (with private key authentication and MATLS)",
...
public class OBEnsureClientIdInTokenEndpointWithPrivateKeyAndMATLS extends AbstractOBServerTestModule {
