...
@PublishTestModule(
	...
	displayName = "FAPI-RW-ID2-OB: client test - if the alg of id_token is PS256, then sign with RS256 in the authorization endpoint, should be rejected (with private_key_jwt and MTLS)",
