...
public class OBEnsureMATLSRequiredCodeWithSecretBasicAndMATLS extends AbstractOBEnsureMATLSRequiredCode {
	...
	public OBEnsureMATLSRequiredCodeWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
