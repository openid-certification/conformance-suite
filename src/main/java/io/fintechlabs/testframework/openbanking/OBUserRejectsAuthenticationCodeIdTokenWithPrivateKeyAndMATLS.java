...
@PublishTestModule(
	testName = "ob-user-rejects-authentication-code-id-token-with-private-key-and-matls",
	displayName = "OB: user rejects authentication ( code id_token with private key authentication and MATLS )",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
