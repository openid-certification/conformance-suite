...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-with-mtls-holder-of-key-invalid-secondary-aud",
	displayName = "FAPI-RW-ID2-OB: client test - multiple aud values in id_token from authorization_endpoint should be rejected (with mtls holder of key)",
...
public class FAPIRWID2OBClientTestWithMTLSHolderOfKeyInvalidSecondaryAud extends AbstractFAPIRWID2OBClientMTLSHolderOfKeyExpectNothingAfterAuthorisationEndpoint {
