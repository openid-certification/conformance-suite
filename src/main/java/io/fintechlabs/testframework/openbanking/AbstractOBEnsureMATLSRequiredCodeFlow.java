...
public abstract class AbstractOBEnsureMATLSRequiredCodeFlow extends AbstractOBServerTestModuleCodeFlow {

	public static Logger logger = LoggerFactory.getLogger(AbstractOBEnsureMATLSRequiredCodeFlow.class);

	public AbstractOBEnsureMATLSRequiredCodeFlow(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
