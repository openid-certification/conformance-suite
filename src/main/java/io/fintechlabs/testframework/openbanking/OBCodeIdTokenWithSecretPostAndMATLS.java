...
@PublishTestModule(
	testName = "ob-code-id-token-with-secret-post-and-matls",
	displayName = "OB: code id_token (client_secret_post authentication with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
...
public class OBCodeIdTokenWithSecretPostAndMATLS extends AbstractOBServerTestModuleCodeIdToken {
