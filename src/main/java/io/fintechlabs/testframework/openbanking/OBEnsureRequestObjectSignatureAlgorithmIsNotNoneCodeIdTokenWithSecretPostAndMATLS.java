...
public class OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdTokenWithSecretPostAndMATLS extends AbstractOBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdToken {
	...
	public OBEnsureRequestObjectSignatureAlgorithmIsNotNoneCodeIdTokenWithSecretPostAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
