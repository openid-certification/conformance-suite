...
public abstract class AbstractOBEnsureRedirectUriInAuthorizationRequestCodeIdToken extends AbstractOBEnsureRedirectUriInAuthorizationRequest {
	...
	public AbstractOBEnsureRedirectUriInAuthorizationRequestCodeIdToken(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
