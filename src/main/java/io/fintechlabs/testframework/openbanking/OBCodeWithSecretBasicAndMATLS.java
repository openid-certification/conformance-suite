...
public class OBCodeWithSecretBasicAndMATLS extends AbstractOBServerTestModuleCode {
	...
	public OBCodeWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
