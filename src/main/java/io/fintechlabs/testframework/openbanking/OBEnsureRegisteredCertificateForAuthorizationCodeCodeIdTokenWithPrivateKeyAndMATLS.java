...
public class OBEnsureRegisteredCertificateForAuthorizationCodeCodeIdTokenWithPrivateKeyAndMATLS extends AbstractOBEnsureRegisteredCertificateForAuthorizationCodeCodeIdToken {
	...
	public OBEnsureRegisteredCertificateForAuthorizationCodeCodeIdTokenWithPrivateKeyAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo, TestExecutionManager executionManager) {
