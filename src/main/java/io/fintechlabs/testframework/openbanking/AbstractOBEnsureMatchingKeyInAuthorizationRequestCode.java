...
public abstract class AbstractOBEnsureMatchingKeyInAuthorizationRequestCode extends AbstractOBEnsureMatchingKeyInAuthorizationRequest {
	...
	public AbstractOBEnsureMatchingKeyInAuthorizationRequestCode(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
