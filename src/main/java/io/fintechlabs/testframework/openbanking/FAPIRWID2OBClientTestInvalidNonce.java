...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-invalid-nonce",
	displayName = "FAPI-RW-ID2-OB: client test - invalid nonce in id_token from authorization_endpoint, should be rejected",
...
public class FAPIRWID2OBClientTestInvalidNonce extends AbstractFAPIRWID2OBClientExpectNothingAfterAuthorizationEndpoint {
