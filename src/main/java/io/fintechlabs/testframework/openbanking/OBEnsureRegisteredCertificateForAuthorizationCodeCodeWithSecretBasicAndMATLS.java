...
public class OBEnsureRegisteredCertificateForAuthorizationCodeCodeWithSecretBasicAndMATLS extends AbstractOBEnsureRegisteredCertificateForAuthorizationCodeCode {
	...
	public OBEnsureRegisteredCertificateForAuthorizationCodeCodeWithSecretBasicAndMATLS(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
