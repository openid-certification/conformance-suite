...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-without-redirect-uri-fails",
	displayName = "FAPI-RW-ID2-OB: ensure request object without redirect_uri fails",
...
public class FAPIRWID2OBEnsureRequestObjectWithoutRedirectUriFails extends AbstractFAPIRWID2EnsureRequestObjectWithoutRedirectUriFails {
