...
@PublishTestModule(
	testName = "ob-client-test-code-id-token-with-matls",
	displayName = "OB: client test (code id_token with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.jwks",
		"client.client_id",
...
public class ObClientTestCodeIdTokenWithMATLS extends AbstractObClientTestCodeIdToken {
