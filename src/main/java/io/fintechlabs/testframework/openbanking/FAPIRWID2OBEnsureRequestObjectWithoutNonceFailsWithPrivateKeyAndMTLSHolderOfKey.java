...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-without-nonce-fails-with-private-key-and-mtls-holder-of-key",
	displayName = "FAPI-RW-ID2-OB: ensure request object without nonce fails (with private key authentication and mtls holder of key)",
...
public class FAPIRWID2OBEnsureRequestObjectWithoutNonceFailsWithPrivateKeyAndMTLSHolderOfKey extends AbstractFAPIRWID2OBEnsureRequestObjectWithoutNonceFails {
