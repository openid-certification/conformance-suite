...
@PublishTestModule(
	testName = "ob-ensure-redirect-uri-in-authorization-request-with-private-key-and-matls",
	displayName = "OB: ensure redirect URI in authorization request (private key authentication with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
