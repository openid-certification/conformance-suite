...
public abstract class AbstractOBEnsureRegisteredCertificateForAuthorizationCodeCodeFlow extends AbstractOBServerTestModuleCodeFlow {

	public AbstractOBEnsureRegisteredCertificateForAuthorizationCodeCodeFlow(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
