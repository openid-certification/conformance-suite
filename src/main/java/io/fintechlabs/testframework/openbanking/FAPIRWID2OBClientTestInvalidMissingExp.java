...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-client-test-invalid-missing-exp",
	displayName = "FAPI-RW-ID2-OB: client test - missing exp value in id_token from authorization_endpoint, should be rejected",
...
public class FAPIRWID2OBClientTestInvalidMissingExp extends AbstractFAPIRWID2OBClientExpectNothingAfterAuthorizationEndpoint {
