...
public abstract class AbstractOBEnsureRegisteredCertificateForAuthorizationCodeHybridFlow extends AbstractOBServerTestModuleHybridFlow {

	public AbstractOBEnsureRegisteredCertificateForAuthorizationCodeHybridFlow(String id, Map<String, String> owner, TestInstanceEventLog eventLog, BrowserControl browser, TestInfoService testInfo) {
