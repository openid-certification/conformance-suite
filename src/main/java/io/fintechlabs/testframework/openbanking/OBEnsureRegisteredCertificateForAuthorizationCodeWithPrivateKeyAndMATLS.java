...
@PublishTestModule(
	testName = "ob-ensure-registered-certificate-for-authorization-code-with-private-key-and-matls",
	displayName = "OB: ensure registered certificate for authorization code (private key authentication with MATLS)",
	profile = "OB",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
