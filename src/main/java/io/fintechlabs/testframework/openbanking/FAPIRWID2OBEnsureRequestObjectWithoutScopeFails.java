...
@PublishTestModule(
	testName = "fapi-rw-id2-ob-ensure-request-object-without-scope-fails",
	displayName = "FAPI-RW-ID2-OB: ensure request object without scope fails",
...
public class FAPIRWID2OBEnsureRequestObjectWithoutScopeFails extends AbstractFAPIRWID2EnsureRequestObjectWithoutScopeFails {
