...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-registered-certificate-for-authorization-code-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure registered certificate for authorization code (code with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedEnsureRegisteredCertificateForAuthorizationCodeCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedEnsureRegisteredCertificateForAuthorizationCodeCode {
