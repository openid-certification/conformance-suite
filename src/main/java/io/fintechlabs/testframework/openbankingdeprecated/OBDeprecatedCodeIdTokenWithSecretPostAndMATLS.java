...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-id-token-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: code id_token (client_secret_post authentication with MATLS)",
...
public class OBDeprecatedCodeIdTokenWithSecretPostAndMATLS extends AbstractOBDeprecatedServerTestModuleCodeIdToken {
