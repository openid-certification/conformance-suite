...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-id-token-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: code id_token (client_secret_basic authentication with MATLS)",
...
public class OBDeprecatedCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBDeprecatedServerTestModuleCodeIdToken {
