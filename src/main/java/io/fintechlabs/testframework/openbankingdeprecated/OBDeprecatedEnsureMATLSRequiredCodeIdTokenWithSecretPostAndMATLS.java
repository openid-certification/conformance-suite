...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-matls-required-code-id-token-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure MATLS required (code id_token with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedEnsureMATLSRequiredCodeIdTokenWithSecretPostAndMATLS extends AbstractOBDeprecatedEnsureMATLSRequiredCodeIdToken {
