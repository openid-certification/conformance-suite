...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-matls-required-code-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure MATLS required (code with client_secret_basic authentication and MATLS)",
...
public class OBDeprecatedEnsureMATLSRequiredCodeWithSecretBasicAndMATLS extends AbstractOBDeprecatedEnsureMATLSRequiredCode {
