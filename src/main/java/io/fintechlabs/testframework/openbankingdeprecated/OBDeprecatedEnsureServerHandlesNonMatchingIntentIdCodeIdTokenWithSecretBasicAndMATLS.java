...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-server-handles-non-matching-intent-id-code-id-token-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: server handles non matching openbanking_intent_id (code id_token with client_secret_basic authentication and MATLS)",
...
public class OBDeprecatedEnsureServerHandlesNonMatchingIntentIdCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBDeprecatedEnsureServerHandlesNonMatchingIntentIdCodeIdToken {
