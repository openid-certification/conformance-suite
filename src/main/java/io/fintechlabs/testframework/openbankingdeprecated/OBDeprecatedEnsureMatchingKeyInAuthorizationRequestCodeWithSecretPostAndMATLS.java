...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-matching-key-in-authorization-request-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure matching key in authorization request (code with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedEnsureMatchingKeyInAuthorizationRequestCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedEnsureMatchingKeyInAuthorizationRequestCode {
