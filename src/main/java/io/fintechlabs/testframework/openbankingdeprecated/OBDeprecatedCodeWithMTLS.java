...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-with-mtls",
	displayName = "OB-deprecated-EOL-sept-2019: code (MTLS authentication)",
...
public class OBDeprecatedCodeWithMTLS extends AbstractOBDeprecatedServerTestModuleCode {
