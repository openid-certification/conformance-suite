...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-user-rejects-authentication-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: user rejects authentication (code with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedUserRejectsAuthenticationCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedUserRejectsAuthenticationCode {
