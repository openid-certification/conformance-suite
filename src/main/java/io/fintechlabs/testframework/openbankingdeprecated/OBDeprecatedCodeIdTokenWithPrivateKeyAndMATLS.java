...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-id-token-with-private-key-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: code id_token (private key authentication with MATLS)",
...
public class OBDeprecatedCodeIdTokenWithPrivateKeyAndMATLS extends AbstractOBDeprecatedServerTestModuleCodeIdToken {
