...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-registered-redirect-uri-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure registered redirect URI (code with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedEnsureRegisteredRedirectUriCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedEnsureRegisteredRedirectUriCode {
