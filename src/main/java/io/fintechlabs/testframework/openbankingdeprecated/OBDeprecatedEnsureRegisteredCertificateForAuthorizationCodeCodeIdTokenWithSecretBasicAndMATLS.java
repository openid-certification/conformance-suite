...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-registered-certificate-for-authorization-code-code-id-token-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure registered certificate for authorization code (code id_token with client_secret_basic authentication and MATLS)",
...
public class OBDeprecatedEnsureRegisteredCertificateForAuthorizationCodeCodeIdTokenWithSecretBasicAndMATLS extends AbstractOBDeprecatedEnsureRegisteredCertificateForAuthorizationCodeCodeIdToken {
