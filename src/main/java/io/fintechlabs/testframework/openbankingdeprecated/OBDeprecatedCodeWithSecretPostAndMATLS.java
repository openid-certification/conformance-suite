...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: code (client_secret_post authentication with MATLS)",
...
public class OBDeprecatedCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedServerTestModuleCode {
