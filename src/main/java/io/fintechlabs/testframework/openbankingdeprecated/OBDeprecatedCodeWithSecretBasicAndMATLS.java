...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-code-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: code (client_secret_basic authentication with MATLS)",
...
public class OBDeprecatedCodeWithSecretBasicAndMATLS extends AbstractOBDeprecatedServerTestModuleCode {
