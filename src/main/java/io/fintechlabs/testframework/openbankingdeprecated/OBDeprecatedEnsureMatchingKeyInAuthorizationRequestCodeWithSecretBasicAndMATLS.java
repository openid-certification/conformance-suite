...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-matching-key-in-authorization-request-code-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure matching key in authorization request (code with client_secret_basic authentication and MATLS)",
...
public class OBDeprecatedEnsureMatchingKeyInAuthorizationRequestCodeWithSecretBasicAndMATLS extends AbstractOBDeprecatedEnsureMatchingKeyInAuthorizationRequestCode {
