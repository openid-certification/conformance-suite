...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-server-handles-non-matching-intent-id-code-with-secret-post-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: server handles non matching openbanking_intent_id (code with client_secret_post authentication and MATLS)",
...
public class OBDeprecatedEnsureServerHandlesNonMatchingIntentIdCodeWithSecretPostAndMATLS extends AbstractOBDeprecatedEnsureServerHandlesNonMatchingIntentIdCode {
