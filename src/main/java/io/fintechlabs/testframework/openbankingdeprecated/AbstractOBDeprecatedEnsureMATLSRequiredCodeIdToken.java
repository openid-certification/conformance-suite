...
public abstract class AbstractOBDeprecatedEnsureMATLSRequiredCodeIdToken extends AbstractOBDeprecatedServerTestModuleCodeIdToken {

	public static Logger logger = LoggerFactory.getLogger(AbstractOBDeprecatedEnsureMATLSRequiredCodeIdToken.class);
