...
@PublishTestModule(
	testName = "ob-deprecated-eol-sept-2019-ensure-registered-redirect-uri-code-with-secret-basic-and-matls",
	displayName = "OB-deprecated-EOL-sept-2019: ensure registered redirect URI (code with client_secret_basic authentication and MATLS)",
...
public class OBDeprecatedEnsureRegisteredRedirectUriCodeWithSecretBasicAndMATLS extends AbstractOBDeprecatedEnsureRegisteredRedirectUriCode {
