...
@PublishTestModule(
	...
	summary = """
		Sends a PAR request with a client attestation JWT whose 'exp' claim is 10 minutes \
		in the past. The authorization server must reject the request with an invalid_client, \
...
public class VCIIssuerFailOnClientAttestationExpInPast extends AbstractVCIIssuerTestModule {
