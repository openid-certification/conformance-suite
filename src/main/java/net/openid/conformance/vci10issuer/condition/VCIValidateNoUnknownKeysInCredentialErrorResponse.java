 ...
 */
public class VCIValidateNoUnknownKeysInCredentialErrorResponse extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		if (!unexpected.isEmpty()) {
			throw error("Unexpected keys in credential error response. This may indicate the issuer has misunderstood the spec, or it may be using extensions the test suite is unaware of.",
				args("unexpected", unexpected, "expected", expected));
		}

		logSuccess("No unexpected keys in credential error response", args("expected", expected));
