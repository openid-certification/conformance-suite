...
/**
 * Api url: ****
 * Api endpoint: PUT /organisations/ess/poll
 * Api git hash: ****
 *
 */
@ApiName("Raidiam Directory Put Organisations ByOrganisationId")
public class PutOrganisationsByOrganisationIdValidator extends AbstractJsonAssertingCondition {
