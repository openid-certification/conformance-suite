...
public class CreateAuthzenEvaluationsApiRequestSteps extends AbstractConditionSequence {
	...
	public void evaluate() {
		...
		// Per Section 7.1, top-level subject/resource/action are DEFAULTS that each
		...
		if(null != options) {
			callAndStopOnFailure(new CreateAuthzenApiEndpointRequestOptions(options), "AUTHZEN-7.1.2");
		}
