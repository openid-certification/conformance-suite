...
@PublishTestModule(
	testName = "authzen-pdp-interop-evaluation-05",
	displayName = "AuthZEN Evaluation API Test 05",
	summary = "Evaluation API test 05 with payload\n" + AuthzenPDPInteropEvaluation05Test.payload,
	profile = "AuthZEN",
	configurationFields = {
	}
)
public class AuthzenPDPInteropEvaluation05Test extends AbstractAuthzenPDPEvaluationTest {
