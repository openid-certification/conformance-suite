...
@PublishTestModule(
	testName = "authzen-pdp-interop-evaluation-15",
	displayName = "Authzen Evaluation API Test 15",
	summary = "Evaluation API test 15 with payload\n" + AuthzenPDPInteropEvaluation15Test.payload,
	profile = "Authzen",
	configurationFields = {
	}
)
public class AuthzenPDPInteropEvaluation15Test extends AbstractAuthzenPDPEvaluationTest {
