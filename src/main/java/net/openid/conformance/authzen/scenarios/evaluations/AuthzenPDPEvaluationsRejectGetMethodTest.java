...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 10.1: Reject GET method",
	summary = "Per Section 10.1, evaluations requests are made via HTTPS POST. The PDP MUST reject a GET request to the evaluations endpoint with an HTTP 4xx error (typically 405 Method Not Allowed).",
	profile = "Authzen"
)
