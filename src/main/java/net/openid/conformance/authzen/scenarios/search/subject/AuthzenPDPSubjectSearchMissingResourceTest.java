...
@PublishTestModule(
	...
	displayName = "Authzen Subject Search API - Section 10.1.1: Missing resource -- expect HTTP 400",
	summary = "Section 10.1.1 missing required field. Subject Search request omits `resource`; PDP MUST return HTTP 400.\n" + AuthzenPDPSubjectSearchMissingResourceTest.payload,
	profile = "Authzen"
)
