...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 6.1: Batch with fixture decisions validated",
	summary = "Section 6.1 batch with fixture decisions validated. Bob reads record-1 (rule 3 = true) then writes record-1 (rule 4 = false). Validates structure, decision values, and ordering.\n" + AuthzenPDPEvaluationsBatchWithFixtureDecisionsValidatedTest.payload,
	profile = "Authzen"
)
