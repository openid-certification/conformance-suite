...
@PublishTestModule(
	...
	displayName = "Authzen Evaluation API - Section 2.4.1: Missing resource -- expect HTTP 400",
	summary = "Section 2.4.1 missing required field. Request omits `resource`; PDP MUST return HTTP 400.\n" + AuthzenPDPEvaluationMissingResourceTest.payload,
	profile = "Authzen"
)
