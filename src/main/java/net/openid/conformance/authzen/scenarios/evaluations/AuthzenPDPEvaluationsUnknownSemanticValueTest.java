...
@PublishTestModule(
	...
	summary = "Per spec 7.1.2.1, `evaluations_semantic` only accepts `execute_all`, `deny_on_first_deny`, and `permit_on_first_permit`. A request with an unrecognised value MUST be rejected with HTTP 400.",
	profile = "Authzen"
)
