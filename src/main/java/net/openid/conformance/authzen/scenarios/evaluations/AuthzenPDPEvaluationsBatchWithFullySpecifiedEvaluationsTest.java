...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 3.2.5: Batch with fully specified evaluations (no defaults)",
	summary = "Section 3.2.5 batch with fully specified evaluations. Each item supplies subject, action, and resource; expects [true, false].\n" + AuthzenPDPEvaluationsBatchWithFullySpecifiedEvaluationsTest.payload,
	profile = "Authzen"
)
