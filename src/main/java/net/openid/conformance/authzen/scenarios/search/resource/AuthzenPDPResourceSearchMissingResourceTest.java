...
@PublishTestModule(
	...
	displayName = "Authzen Resource Search API - Section 4.7.1: Missing resource -- expect HTTP 400",
	summary = "Section 4.7.1 missing required field. Resource Search request omits `resource`; PDP MUST return HTTP 400.\n" + AuthzenPDPResourceSearchMissingResourceTest.payload,
	profile = "Authzen"
)
