...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 3.2.3: Batch with properties validated",
	summary = "Section 3.2.3 batch with properties validated (rules 2 and 5). Per-evaluation resource properties drive the per-item decision; expects [true, false].\n" + AuthzenPDPEvaluationsBatchWithPropertiesValidatedTest.payload,
	profile = "Authzen"
)
