...
@PublishTestModule(
	...
	displayName = "Authzen Subject Search API - Section 4.2.3: Subject search with subject.id omitted",
	summary = "Section 4.2.3 the harness does not send subject.id in Subject Search requests. The PDP MUST accept the request and return at least alice and bob.\n" + AuthzenPDPSubjectSearchSubjectSearchWithSubjectIdOmittedTest.payload,
	profile = "Authzen"
)
