...
@PublishTestModule(
	...
	displayName = "Authzen Subject Search API - Spec 10.1-1: Reject GET method",
	summary = "Per spec 10.1-1, subject search requests are made via HTTPS POST. The PDP MUST reject a GET request to the subject search endpoint with an HTTP 4xx error (typically 405 Method Not Allowed).",
	profile = "Authzen"
)
