...
@PublishTestModule(
	...
	displayName = "Authzen Subject Search API - Section 4.7.2: Resource missing type -- expect HTTP 400",
	summary = "Section 4.7.2 missing required sub-field. Subject Search resource omits `type`; PDP MUST return HTTP 400.\n" + AuthzenPDPSubjectSearchResourceMissingTypeTest.payload,
	profile = "Authzen"
)
