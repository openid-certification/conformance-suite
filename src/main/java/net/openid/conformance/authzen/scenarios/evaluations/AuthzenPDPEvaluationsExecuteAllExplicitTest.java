...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Spec 7.1.2.1: evaluations_semantic explicitly set to execute_all",
	summary = "Per spec 7.1.2.1, `evaluations_semantic: \"execute_all\"` MUST be accepted and MUST process every evaluation regardless of earlier decisions. Sends the same mixed permit/deny batch as the default-semantic test with the option set explicitly.\n" + AuthzenPDPEvaluationsExecuteAllExplicitTest.payload,
	profile = "Authzen"
)
