...
@PublishTestModule(
	...
	displayName = "Authzen Evaluation API - Section 2.6: Idempotency",
	summary = "Section 2.6 idempotency. The harness sends the same fixture request multiple times consecutively; the PDP MUST return the same decision value each time.\n" + AuthzenPDPEvaluationIdempotencyTest.payload,
	profile = "Authzen"
)
