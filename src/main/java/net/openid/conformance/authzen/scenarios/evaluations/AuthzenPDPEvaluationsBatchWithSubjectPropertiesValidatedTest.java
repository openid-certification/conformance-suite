...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 3.2.4: Batch with subject properties validated",
	summary = "Section 3.2.4 batch with subject properties validated (rules 5 and 6). Per-evaluation subject properties drive the per-item decision; expects [false, true].\n" + AuthzenPDPEvaluationsBatchWithSubjectPropertiesValidatedTest.payload,
	profile = "Authzen"
)
