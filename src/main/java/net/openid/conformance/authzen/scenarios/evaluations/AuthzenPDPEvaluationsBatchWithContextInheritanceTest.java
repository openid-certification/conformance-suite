...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 6.1: Batch with context inheritance",
	summary = "Section 6.1 batch with context inheritance. Top-level context applies to all evaluations unless overridden per-evaluation. Structural test only.\n" + AuthzenPDPEvaluationsBatchWithContextInheritanceTest.payload,
	profile = "Authzen"
)
