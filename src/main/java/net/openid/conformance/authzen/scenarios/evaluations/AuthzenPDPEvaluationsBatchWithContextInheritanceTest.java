...
@PublishTestModule(
	...
	displayName = "Authzen Evaluations API - Section 3.2.6: Batch with context inheritance",
	summary = "Section 3.2.6 batch with context inheritance. Top-level context applies to all evaluations unless overridden per-evaluation. Structural test only.\n" + AuthzenPDPEvaluationsBatchWithContextInheritanceTest.payload,
	profile = "Authzen"
)
