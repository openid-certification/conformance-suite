...
@PublishTestModule(
	...
	displayName = "Authzen Action Search API - Section 4.7.1: Missing resource -- expect HTTP 400",
	summary = "Section 4.7.1 missing required field. Action Search request omits `resource`; PDP MUST return HTTP 400.\n" + AuthzenPDPActionSearchMissingResourceTest.payload,
	profile = "Authzen"
)
