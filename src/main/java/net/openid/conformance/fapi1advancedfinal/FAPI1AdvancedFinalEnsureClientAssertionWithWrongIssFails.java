...
@PublishTestModule(
	testName = "fapi1-advanced-final-ensure-client-assertion-with-wrong-iss-fails",
	displayName = "FAPI1-Advanced-Final: ensure client_assertion with wrong iss fails",
	summary = "This test passes a client assertion where 'iss' has a wrong value (not equal to the client_id) to the token endpoint. Per RFC7523 section 3 and OIDC Core section 9 the iss claim must contain the client_id of the OAuth client. The server must reject this, returning an 'invalid_client' or 'invalid_request' error.",
...
public class FAPI1AdvancedFinalEnsureClientAssertionWithWrongIssFails extends AbstractFAPI1AdvancedFinalPerformTokenEndpoint {
	@Override
	protected void addClientAuthenticationToTokenEndpointRequest() {
		mapClientAuthKeys("token_endpoint_request_form_parameters", "token_endpoint_request_headers");
		callAndStopOnFailure(CreateClientAuthenticationAssertionClaims.class);

		callAndStopOnFailure(AddWrongIssToClientAssertionClaims.class, "RFC7523-3", "OIDCC-9");
