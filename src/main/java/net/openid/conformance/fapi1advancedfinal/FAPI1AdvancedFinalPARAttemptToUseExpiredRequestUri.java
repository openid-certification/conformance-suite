...
// HTTP response code.
@PublishTestModule(
	testName = "fapi1-advanced-final-par-attempt-to-use-expired-request_uri",
...
public class FAPI1AdvancedFinalPARAttemptToUseExpiredRequestUri extends AbstractFAPI1AdvancedFinalServerTestModule {
