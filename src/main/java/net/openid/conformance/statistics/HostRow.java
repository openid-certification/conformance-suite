...
/**
 * One external server the suite has been pointed at, over the whole history of the
 * database. Passed straight through to the client, so the timestamp is a string.
 *
