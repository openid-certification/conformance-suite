...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-ensure-signed-client-assertion-with-RS256-fails",
	displayName = "FAPI2-Security-Profile-ID2: ensure signed client assertion with RS256 fails",
...
public class FAPI2SPID2EnsureSignedClientAssertionWithRS256Fails extends AbstractFAPI2SPID2PerformTokenEndpoint {
