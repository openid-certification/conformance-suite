...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-request-object-without-redirect-uri-fails",
	displayName = "FAPI2-SecurityProfile-ID2: ensure request object without redirect_uri fails",
