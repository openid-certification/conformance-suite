...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-request-object-signature-algorithm-is-not-none",
	displayName = "FAPI2-SecurityProfile-ID2: ensure request object signature algorithm is not none",
