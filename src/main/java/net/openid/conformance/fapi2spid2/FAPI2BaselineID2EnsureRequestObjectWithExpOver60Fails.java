...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-request-object-with-exp-over-60-fails",
	displayName = "FAPI2-SecurityProfile-ID2: ensure request object with exp value of more then than 60 minutes after the nbf value fails",
...
public class FAPI2BaselineID2EnsureRequestObjectWithExpOver60Fails extends AbstractFAPI2BaselineID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
