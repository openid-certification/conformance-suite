...
public class FAPI2MessageSigningID1TestPlan implements TestPlan {
	public static final List<Class<? extends TestModule>> testModules = List.of(
		...
		FAPI2SPID2PAREnsureJWTClientAssertionWithNbfOver60SecondsInTheFutureFails.class,
		FAPI2SPID2PAREnsureJWTClientAssertionWithIatOver60SecondsInTheFutureFails.class,
