...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-ensure-request-object-with-bad-aud-fails",
	displayName = "FAPI2-Security-Profile-ID2: ensure request object with bad values of aud fails",
...
public class FAPI2SPID2EnsureRequestObjectWithBadAudFails extends AbstractFAPI2SPID2PARExpectingAuthorizationEndpointPlaceholderOrCallback {
