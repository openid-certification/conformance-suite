...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-client-id-in-token-endpoint",
...
public class FAPI2SPID2EnsureClientIdInTokenEndpoint extends AbstractFAPI2SPID2PerformTokenEndpoint {
