...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-client-test-token-endpoint-response-without-expires_in",
	displayName = "FAPI2-SecurityProfile-ID2: client test - return the token endpoint response without the expires_in parameter",
