...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-ensure-request-object-without-scope-fails",
	displayName = "FAPI2-Security-Profile-ID2: ensure request object without scope fails",
...
public class FAPI2SPID2EnsureRequestObjectWithoutScopeFails extends AbstractFAPI2SPID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
