...
@PublishTestModule(
		testName = "fapi2-security-profile-id2-par-test-array-as-audience-fails",
		displayName = "FAPI2-Security-Profile-ID2: ensure jwt client assertions with array as audience fails at the par endpoint",
...
public class FAPI2SPID2PAREndpointAsArrayAudienceFails extends AbstractFAPI2SPID2ServerTestModule {
	@Override
