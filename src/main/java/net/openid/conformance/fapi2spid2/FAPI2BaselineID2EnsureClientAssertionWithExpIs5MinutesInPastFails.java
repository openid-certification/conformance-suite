...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-client-assertion-with-exp-is-5-minutes-in-past-fails",
	displayName = "FAPI2-Baseline-ID2: ensure client_assertion with exp is 5 minutes in the past fails",
...
public class FAPI2BaselineID2EnsureClientAssertionWithExpIs5MinutesInPastFails extends AbstractFAPI2BaselineID2PerformTokenEndpoint {
