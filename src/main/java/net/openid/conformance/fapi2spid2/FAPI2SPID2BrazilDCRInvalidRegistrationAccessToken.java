...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-brazildcr-invalid-registration-access-token",
	displayName = "FAPI2-Security-Profile-ID2: Brazil DCR invalid registration access token",
...
public class FAPI2SPID2BrazilDCRInvalidRegistrationAccessToken extends AbstractFAPI2SPID2BrazilDCR {
