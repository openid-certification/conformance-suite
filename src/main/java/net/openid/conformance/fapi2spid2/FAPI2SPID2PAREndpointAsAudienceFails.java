...
@PublishTestModule(
		testName = "fapi2-security-profile-id2-par-test-par-endpoint-url-as-audience-fails",
		displayName = "FAPI2-Security-Profile-ID2: ensure jwt client assertions with par endpoint as audience fails at the par endpoint",
...
public class FAPI2SPID2PAREndpointAsAudienceFails extends AbstractFAPI2SPID2ServerTestModule {
	@Override
