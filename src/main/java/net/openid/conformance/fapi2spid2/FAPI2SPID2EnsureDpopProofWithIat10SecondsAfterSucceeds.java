...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-ensure-dpopproof-with-iat-10seconds-after-succeeds",
	displayName = "FAPI2-Security-Profile-ID2: ensure DPoP proofs with 'iat' claim of 10 seconds in the future succeed",
...
public class FAPI2SPID2EnsureDpopProofWithIat10SecondsAfterSucceeds extends AbstractFAPI2SPID2ServerTestModule {
	@Override
	...
	public void setupCreateDpopForEndpointSteps() {
		createDpopForParEndpointSteps = () -> CreateDpopProofSteps.createParEndpointDpopSteps()
			.insertBefore(SignDpopProof.class, condition(SetDpopIatTo10SecondsAfter.class));
