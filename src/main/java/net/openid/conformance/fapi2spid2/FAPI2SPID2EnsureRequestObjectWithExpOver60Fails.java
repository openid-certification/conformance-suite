...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-ensure-request-object-with-exp-over-60-fails",
	displayName = "FAPI2-Security-Profile-ID2: ensure request object with exp value of more then than 60 minutes after the nbf value fails",
...
public class FAPI2SPID2EnsureRequestObjectWithExpOver60Fails extends AbstractFAPI2SPID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
