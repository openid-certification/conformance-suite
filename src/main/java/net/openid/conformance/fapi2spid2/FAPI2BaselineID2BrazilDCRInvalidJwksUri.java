...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-brazil-dcr-invalid-jwks-uri",
	displayName = "FAPI2-SecurityProfile-ID2: Brazil DCR Invalid JWKS URI",
...
public class FAPI2BaselineID2BrazilDCRInvalidJwksUri extends AbstractFAPI2BaselineID2BrazilDCR {
