...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-test-essential-acr-sca-claim",
	displayName = "FAPI2-Security-Profile-ID2: check behaviour of openbankinguk server when an essential acr claim for SCA is made",
...
@VariantNotApplicable(parameter = FAPI2ID2OPProfile.class, values = { "plain_fapi", "consumerdataright_au", "openbanking_brazil", "connectid_au" })
