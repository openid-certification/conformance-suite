...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-par-ensure-jwt-client-assertions-iat-over-60-seconds-in-the-future-fails",
	displayName = "FAPI2-Security-Profile-ID2: ensure jwt client assertions with iat over 60 seconds in the future fails at the par endopint",
	summary = "This test makes a PAR request with a client assertion 'iat' of >60 seconds in the future.",
...
public class FAPI2SPID2PAREnsureJWTClientAssertionWithIatOver60SecondsInTheFutureFails extends AbstractFAPI2SPID2ServerTestModule {
	@Override
	protected void addClientAuthenticationToPAREndpointRequest() {
		call(new CreateJWTClientAuthenticationAssertionAndAddToPAREndpointRequest().insertAfter(
			...
			condition(AddIatOver60SecondsInTheFutureToClientAuthenticationAssertionClaims.class).requirements("PAR-2", "RFC7519-4.1.6")));
	}
