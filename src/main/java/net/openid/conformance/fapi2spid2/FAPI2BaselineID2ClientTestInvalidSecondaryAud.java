...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-client-test-invalid-secondary-aud",
	displayName = "FAPI2-SecurityProfile-ID2: client test - untrusted aud value in id_token from token_endpoint, must be rejected",
...
public class FAPI2BaselineID2ClientTestInvalidSecondaryAud extends AbstractFAPI2BaselineID2ClientExpectNothingAfterIdTokenIssued {
