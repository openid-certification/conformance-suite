...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-brazildcr-update-client-config-invalid-jwks-by-value",
...
public class FAPI2SPID2BrazilDCRUpdateClientConfigInvalidJwksByValue extends AbstractFAPI2SPID2BrazilDCR {
