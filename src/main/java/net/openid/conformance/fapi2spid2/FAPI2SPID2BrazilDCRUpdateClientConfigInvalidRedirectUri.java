...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-brazildcr-update-client-config-invalid-redirect-uri",
	displayName = "FAPI2-SecurityProfile-ID2: Brazil DCR update client config invalid redirect uri",
...
public class FAPI2BaselineID2BrazilDCRUpdateClientConfigInvalidRedirectUri extends AbstractFAPI2BaselineID2BrazilDCR {
