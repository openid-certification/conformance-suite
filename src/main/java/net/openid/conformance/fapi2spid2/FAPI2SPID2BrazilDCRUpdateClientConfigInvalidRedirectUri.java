...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-brazildcr-update-client-config-invalid-redirect-uri",
	displayName = "FAPI2-Security-Profile-ID2: Brazil DCR update client config invalid redirect uri",
...
public class FAPI2SPID2BrazilDCRUpdateClientConfigInvalidRedirectUri extends AbstractFAPI2SPID2BrazilDCR {
