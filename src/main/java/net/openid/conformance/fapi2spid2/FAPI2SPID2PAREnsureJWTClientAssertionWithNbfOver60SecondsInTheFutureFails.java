...
import net.openid.conformance.condition.client.AddNbfOver60SecondsInTheFutureToClientAuthenticationAssertionClaims;
...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-apr-ensure-jwt-client-assertions-nbf-over-60-seconds-in-the-future-fails",
...
public class FAPI2SPID2PAREnsureJWTClientAssertionWithNbfOver60SecondsInTheFutureFails extends AbstractFAPI2SPID2ServerTestModule {
	@Override
	protected void addClientAuthenticationToPAREndpointRequest() {
		call(((new CreateJWTClientAuthenticationAssertionAndAddToPAREndpointRequest()).insertAfter(
			...
			condition(AddNbfOver60SecondsInTheFutureToClientAuthenticationAssertionClaims.class).requirements("PAR-2", "RFC7519-4.1.5"))));
	}
