...
import net.openid.conformance.condition.client.AddNbf8SecondsInTheFutureToClientAuthenticationAssertionClaims;
...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-psr-ensure-jwt-client-assertions-nbf-8-seconds-in-the-future-is-accepted",
...
public class FAPI2SPID2PAREnsureJWTClientAssertionWithNbf8SecondsInTheFutureIsAccepted extends AbstractFAPI2SPID2ServerTestModule {
	@Override
	protected void addClientAuthenticationToPAREndpointRequest() {
		call(((new CreateJWTClientAuthenticationAssertionAndAddToPAREndpointRequest()).insertAfter(
			...
			condition(AddNbf8SecondsInTheFutureToClientAuthenticationAssertionClaims.class).requirements("PAR-2", "RFC7519-4.1.5"))));
	}
}
