...
public abstract class AbstractFAPI2SPID2ClientTest extends AbstractTestModule {
	...
	protected AccessTokenSenderConstrainMethod fapi2SenderConstrainMethod;
	...
	protected Boolean isDpopConstrain() {
		return fapi2SenderConstrainMethod == AccessTokenSenderConstrainMethod.DPOP;
	}

	protected Boolean isMTLSConstrain() {
		return fapi2SenderConstrainMethod == AccessTokenSenderConstrainMethod.MTLS;
	}
	...
	public void configure(JsonObject config, String baseUrl, String externalUrlOverride, String baseMtlsUrl) {
		...
		fapi2SenderConstrainMethod = getVariant(AccessTokenSenderConstrainMethod.class);
