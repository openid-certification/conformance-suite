...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-request-object-without-nbf-fails",
	displayName = "FAPI2-Baseline-ID2: ensure request object without nbf fails",
...
public class FAPI2BaselineID2EnsureRequestObjectWithoutNbfFails extends AbstractFAPI2BaselineID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
