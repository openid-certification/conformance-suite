...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-client-assertion-with-no-sub-fails",
	displayName = "FAPI2-SecurityProfile-ID2: ensure client_assertion with no sub fails",
...
public class FAPI2BaselineID2EnsureClientAssertionWithNoSubFails extends AbstractFAPI2BaselineID2PerformTokenEndpoint {
	@Override
