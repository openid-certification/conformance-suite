...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-ensure-expired-request-object-fails",
	displayName = "FAPI2-SecurityProfile-ID2: ensure expired request object fails",
...
public class FAPI2SPID2EnsureExpiredRequestObjectFails extends AbstractFAPI2SPID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
