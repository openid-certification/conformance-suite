...
@PublishTestModule(
	testName = "fapi2-security-profile-id2-par-attempt-invalid-http-method",
...
public class FAPI2SPID2PARRejectInvalidHttpVerb extends AbstractFAPI2SPID2ServerTestModule {
