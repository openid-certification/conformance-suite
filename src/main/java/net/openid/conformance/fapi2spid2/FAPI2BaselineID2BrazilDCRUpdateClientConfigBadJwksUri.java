...
@PublishTestModule(
	testName = "fapi2-securityprofile-id2-brazildcr-update-client-config-bad-jwks-uri",
...
public class FAPI2BaselineID2BrazilDCRUpdateClientConfigBadJwksUri extends AbstractFAPI2BaselineID2BrazilDCR {
