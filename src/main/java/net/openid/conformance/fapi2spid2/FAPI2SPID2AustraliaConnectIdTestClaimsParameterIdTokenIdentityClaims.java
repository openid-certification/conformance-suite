...
@PublishTestModule(
	...
	summary = "The test will request all valid ConnectID identity claims and check those contained in the server's discovery document 'claims_supported' paramter are returned in the id_token (using a variety of different forms of request), and will fail if any are not returned.",
