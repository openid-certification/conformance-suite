...
public class AddEssentialUnknownVerifiedClaimToAuthorizationEndpointRequest extends AbstractAddVerifiedClaimToAuthorizationEndpointRequest {
	...
	public Environment evaluate(Environment env) {
		...
		String randomClaimName = UUID.randomUUID().toString();
		JsonObject randomClaimInfo = new JsonObject();
		randomClaimInfo.addProperty("essential", Boolean.TRUE);
