...
public class AddUnknownVerifiedClaimToAuthorizationEndpointRequest extends AbstractAddVerifiedClaimToAuthorizationEndpointRequest {
	...
	public Environment evaluate(Environment env) {
		...
		logSuccess("Added verified claims to authorization request, including a random claim name",
