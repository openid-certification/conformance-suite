...
import net.openid.conformance.condition.client.CreateKSAAccountRequest;
import net.openid.conformance.condition.client.CreateKSAAccountRequestWithExpiration;
import net.openid.conformance.condition.client.CreateTokenEndpointRequestForClientCredentialsGrant;
import net.openid.conformance.condition.client.ExtractAccessTokenFromTokenResponse;
import net.openid.conformance.condition.client.ExtractExpiresInFromTokenEndpointResponse;
import net.openid.conformance.condition.client.ExtractKSAAccountRequestIdFromAccountRequestsEndpointResponse;
...
public class OpenBankingKSAPreAuthorizationSteps extends AbstractConditionSequence {
	...
	public void evaluate() {
		...
		if (secondClient) {
			callAndStopOnFailure(CreateKSAAccountRequestWithExpiration.class);
		} else {
			callAndStopOnFailure(CreateKSAAccountRequest.class);
		}
		...
		callAndStopOnFailure(ExtractKSAAccountRequestIdFromAccountRequestsEndpointResponse.class);
