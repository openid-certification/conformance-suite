...
import net.openid.conformance.condition.client.VerifyClientTokenEndpointAuthCredentials;
...
public class CallDynamicRegistrationEndpointAndVerifySuccessfulResponse extends AbstractConditionSequence {
	...
	public void evaluate() {
		...
		callAndContinueOnFailure(VerifyClientTokenEndpointAuthCredentials.class,  Condition.ConditionResult.FAILURE, "OIDCR-3.2");
