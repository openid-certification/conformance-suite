...
public class SharedAutomatedTellerMachinesValidator extends AbstractJsonAssertingCondition {
	...
	private void assertServices(JsonObject data) {
		Set<String> namesEnum = Sets.newHashSet("ABERTURA_CONTAS_DEPOSITOS_OU_PAGAMENTO_PRE_PAGA", "SAQUE_MOEDA_EM_ESPECIE",
		...
		Set<String> codesEnum = Sets.newHashSet("ABRE_CONTA_DEPOSITO_OU_PRE_PAGA", "SAQUE_MOEDA_ESPECIE", "RECEBE_PAGA_QUALQUER_NATUREZA",
