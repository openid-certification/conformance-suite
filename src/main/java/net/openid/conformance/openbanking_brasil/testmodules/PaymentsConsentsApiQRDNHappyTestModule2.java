...
@PublishTestModule(
	testName = "payments-api-qrdn-good-email-proxy-test-2",
...
public class PaymentsConsentsApiQRDNHappyTestModule2 extends AbstractOBBrasilQrCodePaymentFunctionalTestModule {
