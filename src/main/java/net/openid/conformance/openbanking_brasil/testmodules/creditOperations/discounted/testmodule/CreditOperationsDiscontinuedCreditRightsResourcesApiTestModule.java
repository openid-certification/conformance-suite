...
@PublishTestModule(
	testName = "discounted-credit-rights-resources-api-test",
	displayName = "Validate structure of discounted credit rights API and Resources API resources",
	summary = "Validate structure of discounted credit rights API and Resources API resources\n" +
		...
		"\u2022 Fetches all active and corresponding with Discounted Credit Rights API resources from the Resources API response\n" +
		"\u2022 Compares Discounted Credit Rights API fetched resources with Resources API fetched resources",
...
public class CreditOperationsDiscontinuedCreditRightsResourcesApiTestModule
	extends CreditOperationsDiscountedCreditRightsApiTestModule{
