...
@PublishTestModule(
	testName = "credit-card-api-page-size-too-big-test-v2",
	...
	summary = "Validates that a request for Credit Card Accounts with page-size > 1000 returns HTTP 422\n" +
		...
		"\u2022 Calls GET Credit Cards Transactions API V2 with page size=1001\n" +
...
public class CreditCardApiPageSizeTooLargeTestModuleV2 extends AbstractOBBrasilFunctionalTestModule {
