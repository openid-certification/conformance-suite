...
import net.openid.conformance.openbanking_brasil.testmodules.support.consent.v2.ValidateCustomerFieldV2;
import net.openid.conformance.testmodule.PublishTestModule;

@PublishTestModule(
	testName = "preflight-check-customer-test-v2",
...
public class PreFlightCheckCustomerV2Module extends AbstractClientCredentialsGrantFunctionalTestModule {
    ...
    protected void runTests() {
		...
		runInBlock("Pre-flight Consent field checks", () -> {
			callAndContinueOnFailure(ValidateCustomerFieldV2.class, Condition.ConditionResult.FAILURE);
		});
    }
}
