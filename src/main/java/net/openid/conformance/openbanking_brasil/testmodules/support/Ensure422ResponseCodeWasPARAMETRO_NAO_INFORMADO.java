...
public class Ensure422ResponseCodeWasPARAMETRO_NAO_INFORMADO extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		if (status.equalsIgnoreCase("PARAMETRO_NAO_INFORMADO")) {
			logSuccess("Error code is PARAMETRO_NAO_INFORMADO  as expected");
		} else {
			throw error ("Incorrect error code "+ status +". PARAMETRO_NAO_INFORMADO");
		}
