...
public interface OBBProfile {
	...
	String OBB_PROFILE = "Open Banking Brasil Functional Tests";
	String OBB_PROFIlE_PHASE1 = "Open Banking Brasil Functional Tests for Phase 1 - Open Data";
	String OBB_PROFIlE_PHASE2 = "Open Banking Brasil Functional Tests for Phase 2 - Customer Data - API Version 1";
	String OBB_PROFIlE_PHASE2_VERSION2 = "Open Banking Brasil Functional Tests for Phase 2 - Customer Data - API Version 2";
	...
	String OBB_PROFILE_DCR = "Open Banking Brasil Functional DCR Tests";
	String OBB_PROFILE_OPEN_INSURANCE = "Open Insurance Functional Tests";
	String OBB_PROFILE_OPEN_INSURANCE_PHASE2 = "Open Insurance Brasil Functional Tests for Phase 2";
