...
public class ConsentDetailsIdentifiedByConsentIdValidator extends AbstractJsonAssertingCondition {
	...
	private void assertInnerFields(JsonObject body) {
		...
		Set<String> permissionsList = Sets.newHashSet("RESOURCES_READ", "RESOURCES_ACCOUNTS_READ", "ACCOUNTS_READ", "ACCOUNTS_BALANCES_READ", "ACCOUNTS_TRANSACTIONS_READ", "ACCOUNTS_OVERDRAFT_LIMITS_READ",
