		...
		return List.of(
			new ModuleListEntry(
				List.of(
					...
					//Disabled until fixed re: OCI-456 PaymentsConsentsApiWrongEmailAddressProxyTestModule.class,
					PaymentsConsentsApiPhoneNumberProxyTestModule.class,
					//Disabled until fixed re: OCI-456 PaymentsConsentsApiIncorrectCPFProxyTestModule.class,
