		...
		return List.of(
			new ModuleListEntry(
				List.of(
					...
					//Disabled until fixed re: OCI-455 PaymentsConsentsApiWrongEmailAddressProxyTestModule.class,
					PaymentsConsentsApiPhoneNumberProxyTestModule.class,
					//Disabled until fixed re: OCI-455 PaymentsConsentsApiIncorrectCPFProxyTestModule.class,
