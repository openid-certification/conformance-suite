...
public class PlanNames {
	...
	public static final String PRODUCTS_N_SERVICES_PERSON_API_TEST_PLAN  = "Functional tests for ProductsNServices - Person API - based on Swagger version: 1.0.0"; // OPIN Person 
	...
	public static final String LIFE_PENSION_PLAN_API_TEST_PLAN = "Functional tests for ProductsNServices - Life Pension API - based on Swagger version: 1.0.2"; // OPIN Life Pension
