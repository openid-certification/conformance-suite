...
public class PlanNames {
	...
	public static final String BUSINESS_CREDIT_CARD_API_TEST_PLAN = "Functional tests for ProductsNServices - BusinessCreditCard API - based on Swagger version: 1.0.0";
	public static final String BUSINESS_FINANCINGS_API_TEST_PLAN = "Functional tests for ProductsNServices - BusinessFinancings API - based on Swagger version: 1.0.0";
	public static final String BUSINESS_INVOICE_FINANCINGS_API_TEST_PLAN = "Functional tests for ProductsNServices - BusinessInvoiceFinancings API - based on Swagger version: 1.0.0";
	public static final String BUSINESS_LOANS_API_TEST_PLAN = "Functional tests for ProductsNServices - BusinessLoans API - based on Swagger version: 1.0.0";
