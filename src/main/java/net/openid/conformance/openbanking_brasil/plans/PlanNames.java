...
public class PlanNames {
	...
	public static final String CREDIT_CARDS_API_PLAN_NAME = "F2 T2 Functional tests for Credit Card API - based on swagger version: 1.0.4 (WIP)";
	public static final String CREDIT_OPERATIONS_API_PLAN_NAME = "F2 T2 Functional tests for credit operations API - based on Swagger version: 1.0.4 (WIP)";
	...
	public static final String LOANS_API_PLAN_NAME = "F2 T2 Functional tests for loans API - based on Swagger version: 1.0.4 (WIP)";
