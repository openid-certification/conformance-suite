...
public class LogEntryHelper {
	...
	static{
		...
		specLinks.put("FAPI2-MS-", "https://openid.bitbucket.io/fapi/fapi-2_0-message-signing.html#section."); // not a stable version - update to implementers draft when available
