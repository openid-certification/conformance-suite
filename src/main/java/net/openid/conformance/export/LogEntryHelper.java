...
public class LogEntryHelper {
	...
	static{
		...
		specLinks.put("OID4VP-", "https://openid.net/specs/openid-4-verifiable-presentations-1_0-ID2.html#section.");
		...
		specLinks.put("OIDSSF-", "https://openid.net/specs/openid-sharedsignals-framework-1_0.html#section-");
		specLinks.put("OIDCAEPIOP-", "https://openid.net/specs/openid-caep-interoperability-profile-1_0-ID1.html#section-");
