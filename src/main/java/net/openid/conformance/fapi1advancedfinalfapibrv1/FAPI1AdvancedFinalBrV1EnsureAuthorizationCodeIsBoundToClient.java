...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-authorization-code-is-bound-to-client",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure authorization code is bound to client",
...
public class FAPI1AdvancedFinalBrV1EnsureAuthorizationCodeIsBoundToClient extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
