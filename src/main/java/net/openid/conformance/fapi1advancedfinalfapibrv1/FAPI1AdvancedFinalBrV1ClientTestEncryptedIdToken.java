...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-encrypted-idtoken",
	displayName = "FAPI1-Advanced-Final-Br-v1: client test encrypted id_token",
...
public class FAPI1AdvancedFinalBrV1ClientTestEncryptedIdToken extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
