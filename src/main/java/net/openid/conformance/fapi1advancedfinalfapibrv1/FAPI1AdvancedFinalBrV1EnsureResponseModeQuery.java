...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-response-mode-query",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure response_mode query",
...
public class FAPI1AdvancedFinalBrV1EnsureResponseModeQuery extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
