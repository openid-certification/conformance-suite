...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-expired-request-object-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure expired request object fails",
...
public class FAPI1AdvancedFinalBrV1EnsureExpiredRequestObjectFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
