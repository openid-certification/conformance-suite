...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-without-nbf-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object without nbf fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutNbfFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
