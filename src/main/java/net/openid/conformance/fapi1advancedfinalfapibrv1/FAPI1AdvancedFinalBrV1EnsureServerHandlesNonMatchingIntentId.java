...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-server-handles-non-matching-intent-id",
	displayName = "FAPI1-Advanced-Final-Br-v1: server handles non matching openbanking_intent_id",
...
@VariantNotApplicable(parameter = FAPI1FinalOPProfile.class, values = {
		...
		"openbanking_ksa"})
public class FAPI1AdvancedFinalBrV1EnsureServerHandlesNonMatchingIntentId extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
