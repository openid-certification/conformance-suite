...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-invalid-registration-access-token",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR invalid registration access token",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRInvalidRegistrationAccessToken extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
