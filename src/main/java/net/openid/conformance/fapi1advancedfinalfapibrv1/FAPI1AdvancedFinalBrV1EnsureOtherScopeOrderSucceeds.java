...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-other-scope-order-succeeds",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure other scope order succeeds",
...
public class FAPI1AdvancedFinalBrV1EnsureOtherScopeOrderSucceeds extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
