...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-nbf-over-60-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with nbf value over 60 minutes in the past fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithNbfOver60Fails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
