...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-happy-flow-variant",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR happy flow variant",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRHappyFlowVariant extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
