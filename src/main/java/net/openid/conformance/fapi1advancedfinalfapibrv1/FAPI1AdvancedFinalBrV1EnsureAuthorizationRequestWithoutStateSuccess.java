...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-authorization-request-without-state-success",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure authorization endpoint request without state success",
...
public class FAPI1AdvancedFinalBrV1EnsureAuthorizationRequestWithoutStateSuccess extends AbstractFAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutState {
