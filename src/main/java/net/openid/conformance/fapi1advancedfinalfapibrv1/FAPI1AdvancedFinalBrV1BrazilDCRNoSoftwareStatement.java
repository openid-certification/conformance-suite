...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazil-dcr-no-software-statement",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR no software statement",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRNoSoftwareStatement extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
