...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-registered-redirect-uri",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure registered redirect URI",
...
public class FAPI1AdvancedFinalBrV1EnsureRegisteredRedirectUri extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
