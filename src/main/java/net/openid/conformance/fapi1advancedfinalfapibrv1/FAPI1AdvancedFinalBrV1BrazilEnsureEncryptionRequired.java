...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazil-ensure-encryption-required",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure encryption is required when passing request object via browser",
...
public class FAPI1AdvancedFinalBrV1BrazilEnsureEncryptionRequired extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
