...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-assertion-with-wrong-aud-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_assertion with wrong aud fails",
...
public class FAPI1AdvancedFinalBrV1EnsureClientAssertionWithWrongAudFails extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
