...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-invalid-secondary-aud",
	displayName = "FAPI1-Advanced-Final-Br-v1: client test - untrusted aud value in id_token from authorization_endpoint, must be rejected",
...
public class FAPI1AdvancedFinalBrV1ClientTestInvalidSecondaryAud extends AbstractFAPI1AdvancedFinalBrV1ClientExpectNothingAfterIdTokenIssued {
