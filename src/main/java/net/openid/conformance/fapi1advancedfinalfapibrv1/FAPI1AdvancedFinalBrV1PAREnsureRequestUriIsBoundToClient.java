...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-par-attempt-to-use-request_uri-for-different-client",
...
public class FAPI1AdvancedFinalBrV1PAREnsureRequestUriIsBoundToClient extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
