...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazil-dcr-invalid-redirect-uri",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR Invalid Redirect URI",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRInvalidRedirectUri extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
