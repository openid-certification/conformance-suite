...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-assertion-with-exp-is-5-minutes-in-past-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_assertion with exp is 5 minutes in the past fails",
...
public class FAPI1AdvancedFinalBrV1EnsureClientAssertionWithExpIs5MinutesInPastFails extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
