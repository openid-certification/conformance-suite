...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-par-attempt-invalid-http-method",
...
public class FAPI1AdvancedFinalBrV1PARRejectInvalidHttpVerb extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
