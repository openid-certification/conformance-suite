...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-brazildcr-happypath-test",
	displayName = "FAPI1-Advanced-Final-Br-v1: client DCR happy path test",
...
public class FAPI1AdvancedFinalBrV1BrazilClientDCRHappyPathTest extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
	...
	public Object handleHttpMtls(String path, HttpServletRequest req, HttpServletResponse res, HttpSession session, JsonObject requestParts) {
		if(path.equals("register")) {
			...
			if (OIDFJSON.getString(requestParts.get("method")).equals("DELETE")) {
				...
				// fapi1-advanced-final-br-v1-brazildcr-happy-flow calls DELETE as it's final step.
