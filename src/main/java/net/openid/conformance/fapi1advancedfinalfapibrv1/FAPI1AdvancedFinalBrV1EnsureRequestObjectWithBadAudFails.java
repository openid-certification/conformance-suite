...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-bad-aud-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with bad values of aud fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithBadAudFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
