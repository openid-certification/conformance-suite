...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-incorrect-pkce-code-verifier-rejected",
	displayName = "FAPI1-Advanced-Final-Br-v1: Incorrect PKCE code_verifier rejected",
...
public class FAPI1AdvancedFinalBrV1PARIncorrectPKCECodeVerifierRejected extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
