...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-without-exp-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object without exp fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutExpFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
