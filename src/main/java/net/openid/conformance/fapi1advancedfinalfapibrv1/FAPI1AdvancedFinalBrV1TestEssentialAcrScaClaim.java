...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-test-essential-acr-sca-claim",
	displayName = "FAPI1-Advanced-Final-Br-v1: check behaviour of openbankinguk server when an essential acr claim for SCA is made",
...
@VariantNotApplicable(parameter = FAPI1FinalOPProfile.class, values = {
		...
		"openbanking_ksa" })
public class FAPI1AdvancedFinalBrV1TestEssentialAcrScaClaim extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
