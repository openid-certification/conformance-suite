...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-invalid-missing-exp",
	displayName = "FAPI1-Advanced-Final-Br-v1: client test - missing exp value in id_token from authorization_endpoint, should be rejected",
...
public class FAPI1AdvancedFinalBrV1ClientTestInvalidMissingExp extends AbstractFAPI1AdvancedFinalBrV1ClientExpectNothingAfterIdTokenIssued {
