...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-without-scope-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object without scope fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutScopeFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
