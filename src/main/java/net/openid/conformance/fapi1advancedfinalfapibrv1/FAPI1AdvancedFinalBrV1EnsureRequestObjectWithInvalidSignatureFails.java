...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-invalid-signature-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with invalid signature fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithInvalidSignatureFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
