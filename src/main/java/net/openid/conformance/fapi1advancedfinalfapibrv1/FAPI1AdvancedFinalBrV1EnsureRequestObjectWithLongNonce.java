...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-long-nonce",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with long nonce",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithLongNonce extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
