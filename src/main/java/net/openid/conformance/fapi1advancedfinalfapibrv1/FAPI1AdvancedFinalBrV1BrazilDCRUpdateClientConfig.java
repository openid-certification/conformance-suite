...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-update-client-config",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRUpdateClientConfig extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
