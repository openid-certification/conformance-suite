 ...
 */
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-no-scope-in-token-endpoint-response",
	displayName = "FAPI1-Advanced-Final-Br-v1: client test - token endpoint response will not contain the granted scopes, should be accepted",
...
public class FAPI1AdvancedFinalBrV1ClientTestNoScopeInTokenEndpointResponse extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
