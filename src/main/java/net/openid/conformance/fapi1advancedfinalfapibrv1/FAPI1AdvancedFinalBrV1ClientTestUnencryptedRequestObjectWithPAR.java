...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-unencrypted-request-object-with-par",
	displayName = "FAPI1-Advanced-Final-Br-v1: test unencrypted request object support when using PAR",
...
public class FAPI1AdvancedFinalBrV1ClientTestUnencryptedRequestObjectWithPAR extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
