...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-long-state",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with long state",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithLongState extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
