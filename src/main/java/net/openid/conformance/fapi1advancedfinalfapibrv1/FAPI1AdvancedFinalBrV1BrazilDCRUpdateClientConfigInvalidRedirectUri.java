...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-update-client-config-invalid-redirect-uri",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR update client config invalid redirect uri",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRUpdateClientConfigInvalidRedirectUri extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
