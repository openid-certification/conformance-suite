...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-with-exp-over-60-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object with exp value of more then than 60 minutes after the nbf value fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithExpOver60Fails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
