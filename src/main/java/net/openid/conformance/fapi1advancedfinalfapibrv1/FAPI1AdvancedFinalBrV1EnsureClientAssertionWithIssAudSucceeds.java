...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-assertion-with-iss-aud-succeeds",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_assertion with AS issuer ID succeeds at the token endpoint",
...
public class FAPI1AdvancedFinalBrV1EnsureClientAssertionWithIssAudSucceeds extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
