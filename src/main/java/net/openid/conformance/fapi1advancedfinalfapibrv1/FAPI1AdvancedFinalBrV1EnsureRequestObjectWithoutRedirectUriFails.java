...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-without-redirect-uri-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object without redirect_uri fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutRedirectUriFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
