...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-signed-client-assertion-with-RS256-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure signed client assertion with RS256 fails",
...
public class FAPI1AdvancedFinalBrV1EnsureSignedClientAssertionWithRS256Fails extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
