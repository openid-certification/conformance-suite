...
@PublishTestModule(
		testName = "fapi1-advanced-final-br-v1",
		displayName = "FAPI1-Advanced-Final-Br-v1",
...
public class FAPI1AdvancedFinalBrV1 extends AbstractFAPI1AdvancedFinalBrV1MultipleClient {
