...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-matching-key-in-authorization-request",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure matching key in authorization request",
...
public class FAPI1AdvancedFinalBrV1EnsureMatchingKeyInAuthorizationRequest extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
