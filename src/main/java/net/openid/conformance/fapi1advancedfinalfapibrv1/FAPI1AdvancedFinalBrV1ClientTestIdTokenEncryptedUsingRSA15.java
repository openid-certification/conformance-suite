...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-test-encrypted-idtoken-usingrsa15",
	displayName = "FAPI1-Advanced-Final-Br-v1: client test id_token encrypted using RSA1_5 algorithm",
...
public class FAPI1AdvancedFinalBrV1ClientTestIdTokenEncryptedUsingRSA15 extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
