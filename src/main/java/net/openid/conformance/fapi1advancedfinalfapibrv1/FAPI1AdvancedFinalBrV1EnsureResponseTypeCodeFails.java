...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-response-type-code-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure response_type code fails",
...
public class FAPI1AdvancedFinalBrV1EnsureResponseTypeCodeFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
