...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-signed-request-object-with-RS256-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure signed request object with RS256 fails",
...
public class FAPI1AdvancedFinalBrV1EnsureSignedRequestObjectWithRS256Fails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
