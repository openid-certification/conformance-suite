...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-par-attempt-reuse-request_uri",
...
public class FAPI1AdvancedFinalBrV1PARAttemptReuseRequestUri extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
