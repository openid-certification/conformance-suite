...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-request-object-without-nonce-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure request object without nonce fails",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutNonceFails extends AbstractFAPI1AdvancedFinalBrV1ExpectingAuthorizationEndpointPlaceholderOrCallback {
