...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-assertion-in-token-endpoint",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_assertion in token endpoint",
...
public class FAPI1AdvancedFinalBrV1EnsureClientAssertionInTokenEndpoint extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
