...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-client-refresh-token-test",
	displayName = "FAPI1-Advanced-Final-Br-v1: client refresh token test",
...
public class FAPI1AdvancedFinalBrV1ClientRefreshTokenTest extends AbstractFAPI1AdvancedFinalBrV1ClientTest {
