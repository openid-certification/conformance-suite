...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-update-client-config-invalid-jwks-by-value",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR update client config",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRUpdateClientConfigInvalidJwksByValue extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
