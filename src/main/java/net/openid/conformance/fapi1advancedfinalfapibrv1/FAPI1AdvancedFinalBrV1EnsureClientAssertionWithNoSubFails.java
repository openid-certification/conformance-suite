...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-assertion-with-no-sub-fails",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_assertion with no sub fails",
...
public class FAPI1AdvancedFinalBrV1EnsureClientAssertionWithNoSubFails extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
	@Override
