...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazil-dcr-no-redirect-uri",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR no redirect uri",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRNoRedirectUri extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
