...
public abstract class AbstractFAPI1AdvancedFinalBrV1ServerTestModule extends AbstractRedirectServerTestModule {
	...
	public static class CreateAuthorizationRequestObjectSteps extends AbstractConditionSequence {
		...
		public void evaluate() {
			...
			callAndStopOnFailure(AddNbfToRequestObject.class, "FAPI1-ADV-5.2.2-17"); // mandatory in FAPI1-Advanced-Final-Br-v1
