...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-state-only-outside-request-object-not-used",
	displayName = "FAPI1-Advanced-Final-Br-v1: check that a state value passed only outside request object is not used",
...
public class FAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutState extends AbstractFAPI1AdvancedFinalBrV1EnsureRequestObjectWithoutState {
