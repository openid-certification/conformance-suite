...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-client-delete",
	displayName = "FAPI1-Advanced-Final-Br-v1: Brazil DCR client deletion",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRClientDeletion extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
