...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-refresh-token",
	displayName = "FAPI1-Advanced-Final-Br-v1: test refresh token behaviours",
...
public class FAPI1AdvancedFinalBrV1RefreshToken extends AbstractFAPI1AdvancedFinalBrV1MultipleClient {
