...
// HTTP response code.
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-par-attempt-to-use-expired-request_uri",
...
public class FAPI1AdvancedFinalBrV1PARAttemptToUseExpiredRequestUri extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
