...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-ensure-client-id-in-token-endpoint",
	displayName = "FAPI1-Advanced-Final-Br-v1: ensure client_id in token endpoint",
...
public class FAPI1AdvancedFinalBrV1EnsureClientIdInTokenEndpoint extends AbstractFAPI1AdvancedFinalBrV1PerformTokenEndpoint {
