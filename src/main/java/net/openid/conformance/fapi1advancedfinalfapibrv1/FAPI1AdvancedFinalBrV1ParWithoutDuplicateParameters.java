...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-par-without-duplicate-parameters",
	displayName = "FAPI1-Advanced-Final-Br-v1: PAR request without duplicate parameters",
...
public class FAPI1AdvancedFinalBrV1ParWithoutDuplicateParameters extends AbstractFAPI1AdvancedFinalBrV1ServerTestModule {
