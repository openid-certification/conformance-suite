...
@PublishTestModule(
	testName = "fapi1-advanced-final-br-v1-brazildcr-update-client-config-bad-jwks-uri",
...
public class FAPI1AdvancedFinalBrV1BrazilDCRUpdateClientConfigBadJwksUri extends AbstractFAPI1AdvancedFinalBrV1BrazilDCR {
