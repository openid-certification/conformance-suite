 ...
 * OID4VP 1.0 section 8.5 for (amongst others) a transaction_data entry with an unknown or
 * unsupported type. https://github.com/openid/OpenID4VP/pull/790 clarifies in section 8.4 that
 * any response a wallet returns for an unsupported transaction_data request must use this error
 * code.
 */
