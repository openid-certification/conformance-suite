...
public abstract class AbstractAddCdrSharingDurationClaimToAuthorizationEndpointRequest extends AbstractAddClaimToAuthorizationEndpointRequest {

	protected abstract long sharingDuration();
	...
	public Environment evaluate(Environment env) {
		...
		claims.addProperty("sharing_duration", sharingDuration());
