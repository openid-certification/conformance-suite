...
public class SetResourcesScopeOnTokenEndpointRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		tokenEndpointRequest.addProperty("scope", "resources");

		logSuccess("Set scope parameter to 'resources'", tokenEndpointRequest);
