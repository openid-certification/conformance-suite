...
public class RemoveStateFromEndSessionEndpointRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		endSessionEndpointRequest.remove("state");

		env.putObject("end_session_endpoint_request", endSessionEndpointRequest);

		logSuccess("Removed state from end session endpoint request", endSessionEndpointRequest);
