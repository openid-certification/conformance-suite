...
public class AddTlsClientAuthSubjectDnWithBrazilShortnameToDynamicRegistrationRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		String subjectDn = env.getString("certificate_subject", "subjectdn_with_shortnames");
		if (Strings.isNullOrEmpty(subjectDn)) {
			throw error("'subjectdn_with_shortnames' not found in TLS certificate");
		}
