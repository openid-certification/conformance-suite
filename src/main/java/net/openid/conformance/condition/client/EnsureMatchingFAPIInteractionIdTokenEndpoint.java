...
public class EnsureMatchingFAPIInteractionIdTokenEndpoint extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		String actual = env.getString("token_endpoint_response_headers", "x-fapi-interaction-id");
