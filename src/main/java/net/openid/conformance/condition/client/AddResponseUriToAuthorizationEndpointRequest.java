...
public class AddResponseUriToAuthorizationEndpointRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		//authorizationEndpointRequest.addProperty("response_uri", responseUri); // lissi wallet doesn't support this
		authorizationEndpointRequest.addProperty("redirect_uri", responseUri);

		//authorizationEndpointRequest.remove("redirect_uri"); // FIXME redirect uri shouldn't be here according to latest spec, but lissi wallet needs it
