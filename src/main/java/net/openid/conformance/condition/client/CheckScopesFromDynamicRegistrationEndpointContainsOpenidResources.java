...
public class CheckScopesFromDynamicRegistrationEndpointContainsOpenidResources extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		String requiredScope = "openid resources";
		...
		if (!missing.isEmpty()) {
			throw error("'scope' in dynamic registration response does not contain the required scopes 'openid' and 'resources'.",
