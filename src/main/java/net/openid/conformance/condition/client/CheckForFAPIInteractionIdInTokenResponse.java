...
public class CheckForFAPIInteractionIdInTokenResponse extends AbstractCondition {

	@Override
	@PreEnvironment(required = "token_endpoint_response_headers")
	public Environment evaluate(Environment env) {

		String interactionIdStr = env.getString("token_endpoint_response_headers", "x-fapi-interaction-id");

		if (Strings.isNullOrEmpty(interactionIdStr)) {
			throw error("x-fapi-interaction-id not found in token endpoint response headers");
		}
