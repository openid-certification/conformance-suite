...
public class SetPaymentsConsentsScopeOnTokenEndpointRequest extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		tokenEndpointRequest.addProperty("scope", "payments consents");

		logSuccess("Set scope parameter to 'payments consents'", tokenEndpointRequest);
