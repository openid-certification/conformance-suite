...
public class FAPIBrazilOpinCheckDiscEndpointAcrValuesSupportedShould extends AbstractValidateJsonArray {

	private static final String environmentVariable = "acr_values_supported";

	private static final String[] SET_VALUES = { "urn:brasil:openinsurance:loa3" };
