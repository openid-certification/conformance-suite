...
/**
 * Variant of {@link CallPAREndpointAllowingDpopNonceError} for flows that combine DPoP
 * authorization-code binding with OAuth 2.0 Attestation-Based Client Authentication: in addition to
 ...
 * {@code par_endpoint_use_attestation_challenge_error}, so the caller can regenerate the client
 ...
 */
public class CallPAREndpointAllowingDpopNonceOrUseAttestationChallengeError
	extends CallPAREndpointAllowingDpopNonceError {
