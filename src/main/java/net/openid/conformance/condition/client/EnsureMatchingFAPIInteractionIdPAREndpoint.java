...
public class EnsureMatchingFAPIInteractionIdPAREndpoint extends AbstractCondition {

	@Override
	@PreEnvironment(required = "pushed_authorization_endpoint_response_headers", strings = "fapi_interaction_id")
	public Environment evaluate(Environment env) {

		// get the client ID from the configuration
		String expected = env.getString("fapi_interaction_id");
		String actual = env.getString("pushed_authorization_endpoint_response_headers", "x-fapi-interaction-id");
