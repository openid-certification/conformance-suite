...
public class ValidateDpopProofAccessTokenHash extends AbstractCondition {
	...
	@Override
	@PreEnvironment(required = { "incoming_dpop_proof", "incoming_dpop_access_token"} )
	public Environment evaluate(Environment env) {

		String dpopAccessToken = env.getString("incoming_dpop_access_token", "value");
		...
		if(!ath.equals(expectedAth)) {
			throw error("Mismatch between DPoP Proof ath and access token", args("expected", expectedAth, "actual", ath));
		}
