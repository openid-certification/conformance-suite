...
public class SetParResponseExpiresInToLessThan5 extends AbstractCondition {

	public static final int EXPIRES_IN = 4;
	...
	public Environment evaluate(Environment env) {
		...
		logSuccess("Set PAR endpoint response expires_in to value > 5", parEndpointResponse);
