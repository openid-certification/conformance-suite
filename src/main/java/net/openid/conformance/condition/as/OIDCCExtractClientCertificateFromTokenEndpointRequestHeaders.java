...
public class OIDCCExtractClientCertificateFromTokenEndpointRequestHeaders extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		try {
			...
			subjectInfo.addProperty("dn", subject.getName(X500Principal.CANONICAL));
