...
public class OIDCCEnsureAuthorizationRequestParametersMatchRequestObject extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		String responseTypeFromHttp = env.getString("authorization_endpoint_request", "params.response_type");
		String clientIdFromHttp = env.getString("authorization_endpoint_request", "params.client_id");
