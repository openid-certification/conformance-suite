...
public class EnsureAuthorizationParametersMatchRequestObject extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		JsonObject params = env.getElementFromObject("authorization_endpoint_http_request", "query_string_params").getAsJsonObject();
		...
		for (String claim : params.keySet()) {
			...
			String param = env.getString("authorization_endpoint_http_request", "query_string_params." + claim);
