...
public class MtlsKeystoreBuilder {
	...
	public static KeyManager[] configureMtls(Environment env) throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, KeyStoreException, IOException, UnrecoverableKeyException {
		...
		String clientKeyKty = env.getString("mutual_tls_authentication", "kty");
		...
		String kty = "RSA";
		if("EC".equals(clientKeyKty)) {
			kty = "EC";
		}
		PrivateKey key = generatePrivateKeyFromDER(kty, keyBytes);
	...
	protected static PrivateKey generatePrivateKeyFromDER(String kty, byte[] keyBytes) throws InvalidKeySpecException, NoSuchAlgorithmException {
