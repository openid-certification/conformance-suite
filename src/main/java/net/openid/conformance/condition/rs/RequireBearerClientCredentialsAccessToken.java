...
public class RequireBearerClientCredentialsAccessToken extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		if (expected == null) {
			throw error("This endpoint must be called with an access token created with the client credentials grant, but a suitable access token has not been created in this run of the test.");
		}
