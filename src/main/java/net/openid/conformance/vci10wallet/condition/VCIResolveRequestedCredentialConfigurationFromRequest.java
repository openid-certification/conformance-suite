	...
	public Environment evaluate(Environment env) {
		...
		if (requestBodyJson.has("credential_identifier")) {
			...
			if (!credentialIdentifier.contains(":")) {
				...
				VCICredentialErrorResponseUtil.updateCredentialErrorResponseInEnv(env, VciErrorCode.UNKNOWN_CREDENTIAL_IDENTIFIER, errorDescription);
		...
		if (resolvedCredentialConfiguration == null) {
			VciErrorCode errorCode = VciErrorCode.UNKNOWN_CREDENTIAL_CONFIGURATION;
			...
			if (requestBodyJson.has("credential_identifier")) {
				...
				errorCode = VciErrorCode.UNKNOWN_CREDENTIAL_IDENTIFIER;
			}
