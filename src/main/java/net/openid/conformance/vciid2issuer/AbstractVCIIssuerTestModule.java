...
public abstract class AbstractVCIIssuerTestModule extends AbstractRedirectServerTestModule {
	...
	protected void configureClient() {
		...
		boolean mtlsRequired = getVariant(AccessTokenSenderConstrainMethod.class) == AccessTokenSenderConstrainMethod.MTLS || getVariant(ClientAuthType.class) == ClientAuthType.MTLS || profileRequiresMtlsEverywhere;
