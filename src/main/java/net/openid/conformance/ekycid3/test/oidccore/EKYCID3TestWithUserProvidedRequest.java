...
@PublishTestModule(
	testName = "ekycid3-server-testuserprovidedrequest",
...
public class EKYCID3TestWithUserProvidedRequest extends AbstractEKYCID3TestWithOIDCCore {

	@Override
	protected void addVerifiedClaimsToAuthorizationRequest() {
		callAndContinueOnFailure(AddUserProvidedClaimsRequestToAuthorizationEndpointRequest.class, Condition.ConditionResult.WARNING, "IAID3-6");
	}
