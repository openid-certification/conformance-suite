 ...
 */
@PublishTestModule(
	testName = "ekycid3-server-unknown-essential-claim-omitted",
...
public class EKYCID3RequestEssentialClaimUnknownToTheOP extends AbstractEKYCID3TestWithOIDCCore {
