...
@PublishTestModule(
	testName = "ekycid3-server-happypath",
...
public class EKYCID3HappyPathTest extends AbstractEKYCID3TestWithOIDCCore {
	...
	protected void validateEKYCSpecificServerConfiguration() {
		//IAID3-9, The OP MUST support the claims parameter and needs to publish this in its openid-configuration using the claims_parameter_supported element.
		callAndContinueOnFailure(CheckDiscEndpointClaimsParameterSupported.class, Condition.ConditionResult.FAILURE, "OIDCD-3", "IAID3-9");
		...
		callAndContinueOnFailure(EnsureVerifiedClaimsSupportedParameterIsTrue.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	...
	protected void validateTrustFrameworksSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateTrustFrameworksSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateEvidenceSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateEvidenceSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateDocumentsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateDocumentsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateDocumentsMethodsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateDocumentsMethodsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateDocumentsValidationMethodsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateDocumentsValidationMethodsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateDocumentsVerificationMethodsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateDocumentsVerificationMethodsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateElectronicRecordsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateElectronicRecordsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateClaimsInVerifiedClaimsSupported() {
		callAndContinueOnFailure(ValidateClaimsInVerifiedClaimsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateAttachmentsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateAttachmentsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}

	protected void validateDigestAlgorithmsSupportedInServerConfiguration() {
		callAndContinueOnFailure(ValidateDigestAlgorithmsSupportedInServerConfiguration.class, Condition.ConditionResult.FAILURE, "IAID3-9");
	}
