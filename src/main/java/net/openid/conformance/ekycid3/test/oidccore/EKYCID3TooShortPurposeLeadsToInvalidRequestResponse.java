 ...
 */
@PublishTestModule(
	testName = "ekycid3-server-short-purpose-invalid-request",
...
public class EKYCID3TooShortPurposeLeadsToInvalidRequestResponse extends AbstractEKYCID3TestWithOIDCCore {
	...
	protected void onAuthorizationCallbackResponse() {
		...
		callAndContinueOnFailure(EnsureInvalidRequestError.class, Condition.ConditionResult.FAILURE, "IAID3-6.1");
		//test ends here
		fireTestFinished();
	}
}
