 ...
 */
@PublishTestModule(
	testName = "ekycid3-server-unknown-claim-specialchars-omitted",
...
public class EKYCID3RequestClaimWithSpecialCharsUnknownToTheOP extends AbstractEKYCID3TestWithOIDCCore {
