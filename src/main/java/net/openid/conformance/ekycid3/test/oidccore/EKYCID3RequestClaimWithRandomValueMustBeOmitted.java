 ...
 */
@PublishTestModule(
	testName = "ekycid3-server-one-claim-with-random-value-omitted",
...
public class EKYCID3RequestClaimWithRandomValueMustBeOmitted extends AbstractEKYCID3TestWithOIDCCore {
	...
	protected void performIdTokenValidation() {
		...
		callAndContinueOnFailure(EnsureIdTokenDoesNotContainVerifiedClaims.class, Condition.ConditionResult.FAILURE,"IAID3-7.7.3");
	}
	...
	protected void requestProtectedResource() {
		...
		callAndContinueOnFailure(EnsureUserinfoDoesNotContainVerifiedClaims.class,  Condition.ConditionResult.FAILURE, "IAID3-7.7.3");
		eventLog.endBlock();
