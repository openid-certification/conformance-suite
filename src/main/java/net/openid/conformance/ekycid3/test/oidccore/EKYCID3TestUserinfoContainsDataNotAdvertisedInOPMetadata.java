...
@PublishTestModule(
	testName = "ekycid3-server-test-userinfo-notfoundinop",
...
public class EKYCID3TestUserinfoContainsDataNotAdvertisedInOPMetadata extends AbstractEKYCID3TestWithOIDCCore {
