 ...
 */
@PublishTestModule(
	testName = "ekycid3-server-long-purpose-invalid-request",
...
public class EKYCID3TooLongPurposeLeadsToInvalidRequestResponse extends AbstractEKYCID3TestWithOIDCCore {
