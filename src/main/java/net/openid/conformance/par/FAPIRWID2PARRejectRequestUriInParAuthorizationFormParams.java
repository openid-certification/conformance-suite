...
@PublishTestModule(
	testName = "fapi-rw-id2-par-authorization-request-containing-request_uri-form-param",
...
public class FAPIRWID2PARRejectRequestUriInParAuthorizationFormParams extends AbstractFAPIRWID2ServerTestModule {
	...
	protected  void performParAuthorizationRequestFlow() {
		...
		callAndContinueOnFailure(EnsurePARInvalidRequestError.class, Condition.ConditionResult.FAILURE, "PAR-2.1-2");
