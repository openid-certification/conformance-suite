...
public class TestDispatcherCorsConfiguration implements CorsConfigurable {
	...
	public static final String WELL_KNOWN_OAUTH_AUTHORIZATION_SERVER = TestDispatcher.WELL_KNOWN_OAUTH_AUTHORIZATION_SERVER + "test/**";
	...
	public Map<String, CorsConfiguration> getCorsConfigurations() {
		...
		return ImmutableMap.of(
			...
			WELL_KNOWN_OAUTH_AUTHORIZATION_SERVER, testDispatcherConfiguration
		);
