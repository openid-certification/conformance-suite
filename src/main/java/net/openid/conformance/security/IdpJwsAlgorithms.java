...
public final class IdpJwsAlgorithms {
	...
	/**
	 * The value OIDC Core assigns to {@code id_token_signed_response_alg} when the
	 * RP registers nothing, used when configuration is blank.
	 */
	public static final SignatureAlgorithm DEFAULT = SignatureAlgorithm.RS256;
