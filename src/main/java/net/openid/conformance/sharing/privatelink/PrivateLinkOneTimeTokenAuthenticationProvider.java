...
public class PrivateLinkOneTimeTokenAuthenticationProvider implements AuthenticationProvider {

	private final OneTimeTokenService oneTimeTokenService;

	private final UserDetailsService userDetailsService;

	public PrivateLinkOneTimeTokenAuthenticationProvider(OneTimeTokenService oneTimeTokenService,
