...
@ApiName("Insurance Financial Risk PolicyInfo V1")
public class OpinInsuranceFinancialRiskPolicyInfoValidatorV1 extends AbstractJsonAssertingCondition {
	...
	private void assertData(JsonObject data) {
		...
		assertField(data,
			new ObjectField
				.Builder("maxLMG")
				.setValidator(this::assertAmountDetails)
				.build());
	...
	private void assertAmountDetails(JsonObject amount) {
		assertField(amount,
			new DoubleField
				.Builder("amount")
				.setPattern("^\\d{1,16}\\.\\d{2}$")
