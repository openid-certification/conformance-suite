...
public class GetLostProfitValidator extends AbstractJsonAssertingCondition {
	private static class Fields extends ProductNServicesCommonFields {
	}

	public static final Set<String> COVERAGE = Sets.newHashSet("PERDA_DE_RECEITA_INTERRUPCAO_DE_NEGOCIOS", "OUTRAS");
