package net.openid.conformance.openinsurance.validator.insurancePetroleum.v1;
...
/**
 * Api Source: swagger/openinsurance/insurancePetroleum/v1/swagger-insurance-petroleum.yaml
 * Api endpoint: /{policyId}/policy-info
 * Api version: 1.0.0
 */

@ApiName("Insurance Petroleum PolicyInfo V1")
public class OpinInsurancePetroleumPolicyInfoValidatorV1 extends AbstractJsonAssertingCondition {
	...
	public static final Set<String> CODE = SetUtils.createSet("RISCOS_DE_PETROLEO, OUTRAS");
