package net.openid.conformance.openinsurance.validator.insuranceAcceptanceAndBranchesAbroad.v1;
...
/**
 * Api Source: swagger/openinsurance/insuranceAcceptanceAndBranchesAbroad/swagger-insurance-acceptance-and-branches-abroad.yaml
 * Api endpoint: /{policyId}/policy-info
 * Api version: 1.0.0
 */

@ApiName("Insurance Acceptance and Branches Abroad PolicyInfo V1")
public class OpinInsuranceAcceptanceAndBranchesAbroadPolicyInfoValidatorV1 extends AbstractJsonAssertingCondition {
	...
	public static final Set<String> CODE = SetUtils.createSet("OUTRAS");
	...
	private void assertBranchInfo(JsonObject branchInfo) {
		...
		assertField(branchInfo,
			new StringField
				.Builder("transferorId")
				.setMaxLength(40)
				.build());

		assertField(branchInfo,
			new StringField
				.Builder("transferorName")
				.setMaxLength(500)
				.build());

		assertField(branchInfo,
			new StringArrayField
				.Builder("groupBranches")
				.setMaxLength(4)
				.build());
	}
}
