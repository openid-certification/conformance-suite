...
/**
 * Api Source: swagger/openinsurance/productsServices/globalBankingStructure.yaml
 * Api endpoint: /global-banking/
 * Api version: 1.0.0
 * Git hash: 18b96a6de31ee788c0f2f06c609bcb6adcc926b3
 */

@ApiName("ProductsServices Global Banking")
public class GetGlobalBankingValidator extends AbstractJsonAssertingCondition {
	private static class Fields extends ProductNServicesCommonFields {
	}

	public static final Set<String> COVERAGE = Sets.newHashSet("DANOS_MATERIAIS_CAUSADOS_AO_COFRE_FORTE", "DANOS_MATERIAIS_CAUSADOS_AOS_CAIXAS_ELETRONICOS_ATM", "INFIDELIDADE_DE_FUNCIONARIOS", "VALORES_NO_INTERIOR_DE_CAIXAS_ELETRONICOS_ATM", "VALORES_EM_MAOS_DE_PORTADORES_EM_TRANSITO", "OUTROS");
