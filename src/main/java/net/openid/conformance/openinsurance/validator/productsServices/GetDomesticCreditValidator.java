...
public class GetDomesticCreditValidator extends AbstractJsonAssertingCondition {
	private static class Fields extends ProductNServicesCommonFields {
	}

	public static final Set<String> COVERAGE = Sets.newHashSet("NAO_PAGAMENTO_DA_CARTEIRA_DE_CLIENTES_DO_SEGURADO", "OUTRAS");
