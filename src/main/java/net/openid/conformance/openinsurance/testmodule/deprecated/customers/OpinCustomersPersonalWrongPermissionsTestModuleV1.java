...
import net.openid.conformance.openinsurance.testmodule.support.ProvideIncorrectPermissionsForCustomerPersonalApi;
import net.openid.conformance.testmodule.PublishTestModule;

@PublishTestModule(
	testName = "opin-customers-personal-api-wrong-permissions-test-v1",
	...
	summary = "Ensures API resource cannot be called with wrong permissions - there will be two browser interactions with this test\n" +
		...
		"\u2022 Calls the GET Customer Personal Qualification Resource V1\n" +
		"\u2022 Expects a 403\n" +
		"\u2022 Calls the GET Customer Personal Complimentary-Information Resource V1\n" +
		"\u2022 Expects a 403\n",
...
public class OpinCustomersPersonalWrongPermissionsTestModuleV1 extends AbstractPermissionsCheckingFunctionalTestModule {
	...
	protected void requestResourcesWithIncorrectPermissions() {
		runInBlock("Ensure we cannot call the  Customer Personal Qualifications V1", () -> {
			call(sequence(CallProtectedResourceExpectingFailureSequence.class));
			callAndContinueOnFailure(ErrorValidator.class, Condition.ConditionResult.FAILURE);
			callAndStopOnFailure(EnsureResponseCodeWas403.class);
		});

		runInBlock("Ensure we cannot call the Customer Personal Identifications V1", () -> {
		...
		runInBlock("Ensure we cannot call the Customer Personal Complimentary-Information V1", () -> {
