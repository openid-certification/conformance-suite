...
import net.openid.conformance.openinsurance.testmodule.customers.v1.OpinCustomerBusinessWrongPermissionsTestModule;
...
public class CustomersBusinessApiTestPlan implements TestPlan {
	public static List<ModuleListEntry> testModulesWithVariants() {
		return List.of(
			new ModuleListEntry(
				List.of(
					OpinCustomerBusinessWrongPermissionsTestModule.class
				),
				List.of(
