...
@PublishTestModule(
	...
	summary = "Sends a DCQL query that requests a credential by type (vct) but without specifying "
		+ "individual claims. The wallet should still return a matching credential — the claims array "
		+ "is optional in the DCQL specification. The wallet may choose which claims to disclose.",
