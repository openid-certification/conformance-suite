...
@PublishTestModule(
	...
	summary = """
		...
		vp_token; it should either return an 'invalid_transaction_data' (§8.5) error response, or abort without responding \
...
public class VP1FinalWalletUnknownTransactionDataType extends AbstractVP1FinalWalletNegativeTestExpectingError {
	...
	protected void validateErrorResponse() {
		...
		callAndContinueOnFailure(EnsureInvalidTransactionDataError.class, ConditionResult.FAILURE, "OID4VP-1FINAL-8.4", "OID4VP-1FINAL-8.5");
	}
}
