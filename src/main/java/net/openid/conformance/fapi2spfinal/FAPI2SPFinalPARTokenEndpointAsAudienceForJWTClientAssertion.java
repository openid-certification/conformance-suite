...
@PublishTestModule(
	testName = "fapi2-security-profile-final-par-test-token-endpoint-url-as-audience-for-client-JWT-assertion",
...
public class FAPI2SPFinalPARTokenEndpointAsAudienceForJWTClientAssertion extends AbstractFAPI2SPFinalServerTestModule {
	/*
	PAR-2.0
