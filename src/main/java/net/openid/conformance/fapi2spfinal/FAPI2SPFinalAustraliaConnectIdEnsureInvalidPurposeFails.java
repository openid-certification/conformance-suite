...
@PublishTestModule(
	...
	displayName = "FAPI2-Security-Profile-Final: test authentication request with `purpose` parameter that exceeds the maximum length is rejected.",
...
@VariantNotApplicable(parameter = FAPI2FinalOPProfile.class, values = { "plain_fapi", "openbanking_uk", "consumerdataright_au", "openbanking_brazil", "cbuae", "openbanking_chile", "ksa", "fapi_client_credentials_grant" })
