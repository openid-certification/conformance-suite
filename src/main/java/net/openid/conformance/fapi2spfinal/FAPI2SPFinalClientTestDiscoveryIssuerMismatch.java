...
@PublishTestModule(
	testName = "fapi2-security-profile-final-client-test-discovery-issuer-mismatch",
	displayName = "FAPI2-Security-Profile-Final: Relying party OpenID discovery issuer mismatch",
...
public class FAPI2SPFinalClientTestDiscoveryIssuerMismatch extends AbstractFAPI2SPFinalClientTest {
