...
@VariantNotApplicable(parameter = FAPI2FinalOPProfile.class, values = {"plain_fapi", "consumerdataright_au", "openbanking_uk", "connectid_au", "fapi_client_credentials_grant", "vci" })
