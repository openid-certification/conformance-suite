...
@PublishTestModule(
	testName = "fapi2-security-profile-final-client-test-valid-aud-as-array",
	displayName = "FAPI2-Security-Profile-Final: client test - valid aud in id_token as data type array",
