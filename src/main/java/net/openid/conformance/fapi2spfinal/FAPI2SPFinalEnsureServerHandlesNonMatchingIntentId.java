...
@PublishTestModule(
	testName = "fapi2-security-profile-final-ensure-server-handles-non-matching-intent-id",
	displayName = "FAPI2-Security-Profile-Final: server handles non matching openbanking_intent_id",
...
@VariantNotApplicable(parameter = FAPI2FinalOPProfile.class, values = { "plain_fapi", "consumerdataright_au", "openbanking_brazil", "openbanking_chile", "connectid_au", "cbuae", "ksa", "fapi_client_credentials_grant" })
