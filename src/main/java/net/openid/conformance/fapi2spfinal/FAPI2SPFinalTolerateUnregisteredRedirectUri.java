...
@VariantNotApplicable(parameter = FAPI2FinalOPProfile.class, values = { "consumerdataright_au", "openbanking_brazil", "connectid_au", "cbuae", "ksa", "openbanking_chile", "fapi_client_credentials_grant" })
