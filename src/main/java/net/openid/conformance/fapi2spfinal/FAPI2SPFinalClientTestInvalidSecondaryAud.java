...
@PublishTestModule(
	testName = "fapi2-security-profile-final-client-test-invalid-secondary-aud",
	displayName = "FAPI2-Security-Profile-Final: client test - untrusted aud value in id_token from token_endpoint, must be rejected",
...
public class FAPI2SPFinalClientTestInvalidSecondaryAud extends AbstractFAPI2SPFinalClientExpectNothingAfterIdTokenIssued {
