...
@PublishTestModule(
	testName = "fapi2-security-profile-final-attempt-reuse-authorization-code-after-one-second",
	displayName = "FAPI2-Security-Profile-Final: try to reuse authorization code after one second",
...
public class FAPI2SPFinalAttemptReuseAuthorizationCodeAfterOneSecond extends AbstractFAPI2SPFinalServerTestModule {
	...
	protected void verifyError() {
		...
		if (httpStatus == HttpStatus.SC_OK) {
			callAndContinueOnFailure(ServerAllowedReusingAuthorizationCode.class, Condition.ConditionResult.FAILURE, "FAPI2-SP-FINAL-5.3.1.2-9");
		} else {
	...
	protected void onPostAuthorizationFlowComplete() {
		...
		callSenderConstrainedTokenEndpointAndStopOnFailure( "FAPI2-SP-FINAL-5.3.1.2-9");
