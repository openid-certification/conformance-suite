...
@PublishTestModule(
	testName = "fapi2-security-profile-final-client-brazildcr-happypath-test",
	displayName = "FAPI2-Security-Profile-Final: client DCR happy path test",
	summary = """
...
public class FAPI2SPFinalBrazilClientDCRHappyPathTest extends AbstractFAPI2SPFinalClientTest {
	...
	public Object handleHttpMtls(String path, HttpServletRequest req, HttpServletResponse res, HttpSession session, JsonObject requestParts) {
		if(path.equals("register")) {
			...
			callAndContinueOnFailure(EnsureIncomingTls12WithSecureCipherOrTls13.class, Condition.ConditionResult.WARNING, "FAPI2-SP-FINAL-5.2.1-1", "FAPI2-SP-FINAL-5.2.1-2");
			...
			if (OIDFJSON.getString(requestParts.get("method")).equals("DELETE")) {
				...
				// fapi2-security-profile-final-brazildcr-happy-flow calls DELETE as it's final step.
