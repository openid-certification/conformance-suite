...
@PublishTestModule(
	testName = "fapi2-security-profile-final-client-test-ensure-jarm-without-aud-fails",
	displayName = "FAPI2-Security-Profile-Final: sends a JARM response without the aud claim.",
...
public class FAPI2SPFinalClientTestEnsureJarmWithoutAudFails extends AbstractFAPI2SPFinalClientExpectNothingAfterAuthorizationResponse {
