...
@PublishTestModule(
	testName = "fapi2-security-profile-final-brazildcr-update-client-config",
...
public class FAPI2SPFinalBrazilDCRUpdateClientConfig extends AbstractFAPI2SPFinalBrazilDCR {
