...
@PublishTestModule(
	...
	summary = "This test sends a ConnectID CIBA 3DS payment backchannel authentication request with authorization_details missing payment_desc. The server must return an invalid_request or invalid_authorization_details error.",
