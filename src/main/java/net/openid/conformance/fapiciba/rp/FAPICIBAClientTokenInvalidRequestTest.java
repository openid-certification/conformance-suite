...
@PublishTestModule(
	...
	summary = "As per the CIBA specification, section 11: " +
		...
		"second request. The client must detect this, and not make further requests to the token endpoint with that auth_req_id",
