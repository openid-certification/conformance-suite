...
@PublishTestModule(
	testName = "fapi-ciba-id1-client-invalid-missing-authreqid-test",
...
public class FAPICIBAClientBackchannelResponseInvalidMissingAuthReqIdTest extends AbstractFAPICIBAClientTest {
