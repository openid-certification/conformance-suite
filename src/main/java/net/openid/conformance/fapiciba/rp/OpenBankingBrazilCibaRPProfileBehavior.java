...
public class OpenBankingBrazilCibaRPProfileBehavior extends FAPICIBARPProfileBehavior {
	...
	public ConditionSequence applyProfileSpecificServerConfigurationSetup() {
		return new AbstractConditionSequence() {
			@Override
			public void evaluate() {
				callAndStopOnFailure(ExtractMTLSCertificatesFromConfiguration.class, "BrazilCIBA-6.3.4");
		...
		return new AbstractConditionSequence() {
			...
			public void evaluate() {
				callAndStopOnFailure(PingClientNotificationEndpointWithRetriesForBrazil.class,
					Condition.ConditionResult.FAILURE, "CIBA-10.2", "BrazilCIBA-6.2.8");
			}
		};
	}
	...
	public ConditionSequence applyProfileSpecificBackchannelRequestChecks() {
		return new AbstractConditionSequence() {
			@Override
			public void evaluate() {
				callAndStopOnFailure(BackchannelRequestRequestedExpiryIsAnInteger.class,
					"CIBA-7.1", "CIBA-7.1.1", "BrazilCIBA-6.3.7");
		...
		return new AbstractConditionSequence() {
			...
			public void evaluate() {
				callAndStopOnFailure(
					SetOpenBankingBrazilCibaAuthenticationRequestMaximumExpiry.class,
					"BrazilCIBA-6.2.6");
			}
		};
	}
