...
@PublishTestModule(
	testName = "fapi-ciba-id1-connectid-ensure-authorization-request-without-binding-message-fails",
...
public class FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithoutBindingMessageFails extends AbstractFAPICIBAID1EnsureSendingInvalidBackchannelAuthorizationRequest {
