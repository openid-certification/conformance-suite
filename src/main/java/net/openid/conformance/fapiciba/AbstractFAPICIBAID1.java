...
@VariantConfigurationFields(parameter = FAPICIBAProfile.class, value = "openfinance_brazil", configurationFields = {
	"client.org_jwks",
	"client.acr_value",
	"consent.productType",
	"resource.consentUrl",
...
@VariantHidesConfigurationFields(parameter = FAPICIBAProfile.class, value = "openfinance_brazil", configurationFields = {
	"client.hint_type",
	"client.hint_value"
})
...
public abstract class AbstractFAPICIBAID1 extends AbstractTestModule {
	...
	protected boolean isBrazil() {
		...
		return profile == FAPICIBAProfile.OPENFINANCE_BRAZIL;
	}
...
//		FIXME	callAndStopOnFailure(AddAccountRequestIdToAuthorizationEndpointRequest.class);
	...
	public static class OpenFinanceBrazilProfileAuthorizationEndpointSetupSteps extends AbstractConditionSequence
	{
		@Override
		public void evaluate() {
...
//			callAndContinueOnFailure(OBValidateIdTokenIntentId.class, Condition.ConditionResult.FAILURE, "OIDCC-2");
	...
	public static class OpenFinanceBrazilProfileIdTokenValidationSteps extends AbstractConditionSequence
	{
		@Override
		public void evaluate() {
	...
	public void configure(JsonObject config, String baseUrl, String externalUrlOverride, String baseMtlsUrl) {
		...
		if (supportMTLSEndpointAliases != null) {
			...
			if (authType != ClientAuthType.MTLS && profile != FAPICIBAProfile.OPENFINANCE_BRAZIL) {
	...
	public void setupOpenFinanceBrazil() {
		...
		additionalProfileAuthorizationEndpointSetupSteps = OpenFinanceBrazilProfileAuthorizationEndpointSetupSteps.class;
		additionalProfileIdTokenValidationSteps = OpenFinanceBrazilProfileIdTokenValidationSteps.class;
	}
