...
@PublishTestModule(
	...
	summary = "This test sends a ConnectID CIBA backchannel authentication request with login_hint set to the configured card primary account number. The configured value must identify a user on the server under test. The server must authenticate successfully.",
