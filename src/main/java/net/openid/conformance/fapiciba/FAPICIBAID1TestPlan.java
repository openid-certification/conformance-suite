...
@PublishTestPlan (
	...
	testModules = {
		...
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithoutBindingMessageFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithTooShortPurposeFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithTooLongPurposeFails.class,
		...
		// Negative tests for ConnectID 3DS payment authorization_details
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentAuthorizationDetailsFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithWrong3DSPaymentAuthorizationDetailsTypeFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentInstructedAmountFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentAmountFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithMalformed3DSPaymentAmountFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentCurrencyFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithMalformed3DSPaymentCurrencyFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentSourceAccountFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithMalformed3DSPaymentSourceAccountFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentBeneficiaryNameFails.class,
		FAPICIBAID1ConnectIdEnsureAuthorizationRequestWithout3DSPaymentDescFails.class,
