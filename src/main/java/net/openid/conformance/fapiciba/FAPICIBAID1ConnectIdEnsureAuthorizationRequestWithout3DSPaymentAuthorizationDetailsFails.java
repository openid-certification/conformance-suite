...
@PublishTestModule(
	...
	summary = "This test sends a ConnectID CIBA 3DS payment backchannel authentication request with no authorization_details in the signed request object. The server must return an invalid_request or invalid_authorization_details error.",
