...
@PublishTestModule(
	testName = "connectid-ciba-ensure-authorization-request-with-purpose-succeeds",
...
public class ConnectIdCibaEnsureAuthorizationRequestWithPurposeSucceeds extends AbstractFAPICIBAID1 {
}
