...
public class FAPICIBAID1EnsureClientAssertionWithIssAudToTokenEndpointSucceeds extends AbstractFAPICIBAID1 {
	...
	protected void addClientAuthenticationToTokenEndpointRequest() {
		...
		call(sequenceOf(sequence(getTokenEndpointClientAuthentication())).insertAfter(CreateClientAuthenticationAssertionClaims.class, condition(UpdateClientAuthenticationAssertionClaimsWithISSAud.class)));
		unmapClientAuthKeys();
	}
