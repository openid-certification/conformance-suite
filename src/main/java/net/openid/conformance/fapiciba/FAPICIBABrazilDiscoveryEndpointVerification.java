...
@PublishTestModule(
	testName = "fapi1-ciba-brazil-discovery-end-point-verification",
...
public class FAPICIBABrazilDiscoveryEndpointVerification extends AbstractFAPI1AdvancedFinalDiscoveryEndpointVerification {
	...
	public static class OpenBankingBrazilDiscoveryEndpointChecks extends AbstractConditionSequence {
		...
		public void evaluate() {
			...
			callAndContinueOnFailure(FAPIBrazilCheckDiscEndpointCpfOrCnpjClaimSupported.class, Condition.ConditionResult.FAILURE, "BrazilOB-5.2.2-3", "BrazilOB-5.2.2-4", "BrazilOB-5.2.2-5", "BrazilOPIN-page8");
			...
			callAndContinueOnFailure(CheckDiscEndpointTokenDeliveryModeSupportedIsPollOnly.class, Condition.ConditionResult.FAILURE, "BrazilCIBA-5.2.2");
		}
	}
}
