...
import net.openid.conformance.condition.client.ExpectCallbackWithInvalidMissingNonceError;
...
public class FAPIRWID2ClientTestInvalidMissingNonce extends AbstractFAPIRWID2ClientExpectNothingAfterAuthorizationEndpoint {
	...
	protected void createPlaceholder() {
		callAndStopOnFailure(ExpectCallbackWithInvalidMissingNonceError.class, "OIDCC-3.1.3.7-11");
	}
