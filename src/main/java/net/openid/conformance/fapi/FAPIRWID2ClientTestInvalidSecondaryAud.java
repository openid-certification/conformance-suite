...
import net.openid.conformance.condition.client.ExpectCallbackWithInvalidSecondaryAudError;
...
public class FAPIRWID2ClientTestInvalidSecondaryAud extends AbstractFAPIRWID2ClientExpectNothingAfterAuthorizationEndpoint {
	...
	protected void createPlaceholder() {
		callAndStopOnFailure(ExpectCallbackWithInvalidSecondaryAudError.class, "OIDCC-3.1.3.7-8");
	}
