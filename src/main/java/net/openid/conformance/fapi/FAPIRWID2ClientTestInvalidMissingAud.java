...
import net.openid.conformance.condition.client.ExpectCallbackWithInvalidMissingAudError;
...
public class FAPIRWID2ClientTestInvalidMissingAud extends AbstractFAPIRWID2ClientExpectNothingAfterAuthorizationEndpoint {
	...
	protected void createPlaceholder() {
		callAndStopOnFailure(ExpectCallbackWithInvalidMissingAudError.class, "OIDCC-3.1.3.7-3");
	}
