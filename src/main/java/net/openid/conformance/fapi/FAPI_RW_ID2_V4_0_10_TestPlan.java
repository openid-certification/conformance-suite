...
@PublishTestPlan (
	testPlanName = "fapi-rw-id2-test-plan-v4.0.10",
	displayName = "FAPI-RW-ID2 (and OpenBankingUK / CDR): Authorization server test (v4.0.10; allowable for certification until 27th November 2020)",
...
public class FAPI_RW_ID2_V4_0_10_TestPlan implements TestPlan {
