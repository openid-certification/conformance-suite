...
public class OpenIDFederationEntityStatementVerification extends AbstractTestModule {
	...
	public void configure(JsonObject config, String baseUrl, String externalUrlOverride, String baseMtlsUrl) {
		...
		JsonObject staticEntityStatement = env.getElementFromObject("config", "server.entityStatement").getAsJsonObject();
		if (staticEntityStatement != null) {
			env.putObject("entity_statement_body", staticEntityStatement);
		} else {
	...
	protected void performEndpointVerification() {
		...
		if (env.containsObject("openid_relying_party_metadata")) {
			...
			call(sequence(OpenIDRelyingPartyValidationSteps.class));
			env.unmapKey("client");
		}
	}

	// This is basically validateClientRegistrationMetadata() found in various FAPI tests
	public class OpenIDRelyingPartyValidationSteps extends AbstractConditionSequence {
		@Override
