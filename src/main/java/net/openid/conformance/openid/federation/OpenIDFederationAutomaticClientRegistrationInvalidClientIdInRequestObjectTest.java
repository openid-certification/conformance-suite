...
public class OpenIDFederationAutomaticClientRegistrationInvalidClientIdInRequestObjectTest extends OpenIDFederationAutomaticClientRegistrationTest {
	...
	public Object handleHttp(String path, HttpServletRequest req, HttpServletResponse res, HttpSession session, JsonObject requestParts) {
		...
		return switch (path) {
			case "INVALID/.well-known/openid-federation" -> new ResponseEntity<>(HttpStatus.NOT_FOUND); // the AS may fetch this
	...
	public Object handleWellKnown(String path,
		...
		if (path.equals("/.well-known/openid-federation/test/a/oidf-authlete-fed/INVALID")) {
