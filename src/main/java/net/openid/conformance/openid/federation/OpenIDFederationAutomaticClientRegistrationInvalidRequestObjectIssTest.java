...
@PublishTestModule(
		...
		displayName = "openid-federation-automatic-client-registration-invalid-request-object-iss",
...
public class OpenIDFederationAutomaticClientRegistrationInvalidRequestObjectIssTest extends OpenIDFederationAutomaticClientRegistrationTest {
	...
	protected void buildRequestObject() {
		...
		callAndContinueOnFailure(AddInvalidIssToRequestObject.class, Condition.ConditionResult.FAILURE);
	}
