...
@PublishTestModule(
	testName = "openid-federation-automatic-client-registration-invalid-request-object-iss",
	displayName = "OpenID Federation OP test: Invalid iss in the request object",
	summary = "The test acts as an RP wanting to perform automatic client registration with an OP, " +
		"deliberately including an invalid iss in the authorization request object." +
		"<br/><br/>" +
		...
		"an invalid iss claim — upload a screenshot of the error page.",
	profile = "OIDFED"
)
@SuppressWarnings("unused")
public class OpenIDFederationAutomaticClientRegistrationInvalidRequestObjectIssTest extends OpenIDFederationAutomaticClientRegistrationTest {
	...
	protected void buildRequestObject() {
		...
		callAndContinueOnFailure(AddInvalidIssToRequestObject.class, Condition.ConditionResult.FAILURE, "OIDFED-12.1.1.1");
	}
