...
public abstract class AbstractOpenIDFederationEnsureFetchFailsTest extends AbstractOpenIDFederationTest {
	...
	public void start() {
		...
		if (!subordinates.isEmpty()) {
			prepareFetchRequest(subordinates);
	...
	protected abstract void prepareFetchRequest(List<String> subordinates);
}
