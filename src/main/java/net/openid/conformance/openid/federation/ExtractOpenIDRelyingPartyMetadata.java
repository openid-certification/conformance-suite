...
public class ExtractOpenIDRelyingPartyMetadata extends AbstractCondition {

	@Override
	@PreEnvironment(required = "entity_statement_body")
	public Environment evaluate(Environment env) {

		JsonElement openidRelyingPartyMetadataElement = env.getElementFromObject("entity_statement_body", "metadata.openid_relying_party");
