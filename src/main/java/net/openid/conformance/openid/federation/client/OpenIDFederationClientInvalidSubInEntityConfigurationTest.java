...
import net.openid.conformance.condition.as.Add10SecondExpValueToIdToken;
...
@PublishTestModule(
	...
	displayName = "openid-federation-client-invalid-sub-in-entity-configuration",
	summary = "openid-federation-client-invalid-sub-in-entity-configuration",
	profile = "OIDFED"
)
...
public class OpenIDFederationClientInvalidSubInEntityConfigurationTest extends OpenIDFederationClientTest {
	...
	protected Object entityConfigurationResponse() {
		...
		callAndContinueOnFailure(Add10SecondExpValueToIdToken.class, Condition.ConditionResult.FAILURE);
