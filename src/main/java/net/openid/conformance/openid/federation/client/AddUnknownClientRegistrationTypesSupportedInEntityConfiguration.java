...
public class AddUnknownClientRegistrationTypesSupportedInEntityConfiguration extends AbstractCondition {
	...
	public Environment evaluate(Environment env) {
		...
		clientRegistrationTypesSupported.add("unknown");
		...
		logSuccess("Added 'unknown', 'automatic' and 'explicit' as client_registration_types_supported in entity configuration",
