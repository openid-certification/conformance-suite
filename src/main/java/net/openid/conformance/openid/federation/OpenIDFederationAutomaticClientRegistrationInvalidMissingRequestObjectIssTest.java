...
@PublishTestModule(
		testName = "openid-federation-automatic-client-registration-invalid-missing-request-object-iss",
		displayName = "openid-federation-automatic-client-registration-invalid-missing-request-object-iss",
		summary = "The test acts as an RP wanting to perform automatic client registration with an OP, " +
			"deliberately not including iss in the authorization request object." +
			"<br/><br/>" +
			...
			"a missing iss claim — upload a screenshot of the error page.",
		profile = "OIDFED"
)
@SuppressWarnings("unused")
public class OpenIDFederationAutomaticClientRegistrationInvalidMissingRequestObjectIssTest extends OpenIDFederationAutomaticClientRegistrationTest {
