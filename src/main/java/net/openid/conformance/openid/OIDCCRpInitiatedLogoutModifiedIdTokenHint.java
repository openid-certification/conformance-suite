...
@PublishTestModule(
	...
	summary = "This test performs a normal authorization flow at the OP, then sends the user to the end_session_endpoint with an id_token_hint that has been changed to alg:none - the OP must show an error screen, a screenshot of which should be uploaded.",
	profile = "OIDCC"
)
