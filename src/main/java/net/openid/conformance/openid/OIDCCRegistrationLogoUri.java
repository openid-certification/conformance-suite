...
@PublishTestModule(
	...
	summary = "This test calls the dynamic registration endpoint with a logo URI. This should result in the browser being redirected to a login page with the RP logo displayed.",
	profile = "OIDCC",
	configurationFields = {
		"server.discoveryUrl"
	}
