...
public abstract class AbstractOIDCCClientBackChannelLogoutTest extends AbstractOIDCCClientLogoutTest
{
	...
	protected void generateLogoutTokenClaims() {
		callAndStopOnFailure(GenerateLogoutTokenClaims.class);
	}
	...
	protected void sendBackChannelLogoutRequest() {
		...
		callAndStopOnFailure(EnsureClientHasBackChannelLogoutUri.class);
		callAndStopOnFailure(CallRPBackChannelLogoutEndpoint.class);
	...
	protected void validateBackChannelLogoutResponse() {
		callAndContinueOnFailure(EnsureBackChannelLogoutEndpointResponseContainsCacheHeaders.class, Condition.ConditionResult.WARNING);
	}
	...
	protected void signLogoutToken() {
		callAndStopOnFailure(OIDCCSignLogoutToken.class);
	}
	...
	protected void encryptLogoutTokenIfNecessary() {
		skipIfElementMissing("client", "id_token_encrypted_response_alg", Condition.ConditionResult.INFO,
			EncryptLogoutToken.class, Condition.ConditionResult.FAILURE, "OIDCC-10.2");
	}
