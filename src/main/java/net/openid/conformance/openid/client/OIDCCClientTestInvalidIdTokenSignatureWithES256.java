...
import net.openid.conformance.condition.as.OIDCCGenerateServerConfigurationIdTokenSigningAlgES256AndRS256;
...
public class OIDCCClientTestInvalidIdTokenSignatureWithES256 extends AbstractOIDCCClientTestExpectingNothingInvalidIdToken {
	...
	protected void configureServerConfiguration() {
		callAndStopOnFailure(OIDCCGenerateServerConfigurationIdTokenSigningAlgES256AndRS256.class);
	}
