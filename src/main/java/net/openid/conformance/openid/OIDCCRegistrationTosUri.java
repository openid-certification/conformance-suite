...
@PublishTestModule(
	...
	summary = "This test calls the dynamic registration endpoint with a TOS URI. This should result in the browser being redirected to a login page with a link to the TOS document displayed.",
	profile = "OIDCC",
	configurationFields = {
		"server.discoveryUrl"
	}
