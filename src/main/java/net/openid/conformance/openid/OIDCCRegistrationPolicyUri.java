...
@PublishTestModule(
	...
	summary = "This test calls the dynamic registration endpoint with a policy URI. This should result in the browser being redirected to a login page with a link to the policy document displayed.",
	profile = "OIDCC",
	configurationFields = {
		"server.discoveryUrl"
	}
