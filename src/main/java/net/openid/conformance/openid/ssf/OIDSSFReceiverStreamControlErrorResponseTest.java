...
@PublishTestModule(testName = "openid-ssf-receiver-stream-control-error-path", displayName = "OpenID Shared Signals Framework: Validate Receiver Stream Control (Error Paths)", summary = "This test verifies the behavior of the receiver stream control.", profile = "OIDSSF", configurationFields = {"ssf.transmitter.issuer", "ssf.transmitter.metadata_suffix", // see: https://openid.net/specs/openid-sharedsignals-framework-1_0.html#section-6.2.1
...
public class OIDSSFReceiverStreamControlErrorResponseTest extends AbstractOIDSSFTest {
