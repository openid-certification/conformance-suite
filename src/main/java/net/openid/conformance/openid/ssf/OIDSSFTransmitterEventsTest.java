...
//			setStatus(Status.WAITING);
		...
		eventLog.runBlock("Verify verification event", () -> {
			...
			callAndStopOnFailure(OIDSSFParseVerificationEventToken.class, "OIDSSF-7.1.4.1");
			callAndStopOnFailure(OIDSSFCheckVerificationEventState.class, "OIDSSF-7.1.4.1");
			callAndStopOnFailure(OIDSSFCheckVerificationEventSubjectId.class, "OIDSSF-7.1.4.1");
