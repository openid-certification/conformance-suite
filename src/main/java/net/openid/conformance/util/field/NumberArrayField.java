...
public class NumberArrayField extends Field {
	...
	private NumberArrayField(boolean optional, boolean nullable, String path, String pattern, int maxLength, int minLength,
	...
	public static class Builder extends FieldBuilder {
		...
		public NumberArrayField build() {
			return new NumberArrayField(this.optional, this.nullable, this.path, this.pattern, this.maxLength,
