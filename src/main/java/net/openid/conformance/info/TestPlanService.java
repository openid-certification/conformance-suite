...
public interface TestPlanService {
	 ...
	 */
	PaginationResponse<Plan> getPaginatedPlansForCurrentUser(PaginationRequest page, PlanListFilter filter);
	 ...
	 * @param filter the narrowing asked for within that scoping
	 */
	PaginationResponse<PublicPlan> getPaginatedPublicPlans(PaginationRequest page, PlanListFilter filter);
