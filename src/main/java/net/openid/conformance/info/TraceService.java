...
public interface TraceService {
	 ...
	 * @param assumeAdmin If true, no access controls will be applied. Only set to
	 *                    true if being called from the
	 *                    test module itself, not via the REST API.
	 * @return Optional containing the trace bytes (ZIP file), or empty if no trace
	 *         exists
	 */
