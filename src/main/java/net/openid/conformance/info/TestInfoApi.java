...
@Controller
@Tag(name = "TestInfoAPI", description = "A set of apis to query test details")
...
//		return new ResponseEntity<>(testInfo, HttpStatus.OK);
    ...
    public ResponseEntity<Object> publishTestInfo(@Parameter(description = "Id of test that you want to publish") @PathVariable("id") String id, @Parameter(description = "Configuration Json") @RequestBody JsonObject config) {
