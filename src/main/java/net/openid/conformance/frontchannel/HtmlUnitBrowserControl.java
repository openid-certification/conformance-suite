...
public class HtmlUnitBrowserControl extends BrowserControl implements DataUtils {
	...
	private static final Logger logger = LoggerFactory.getLogger(HtmlUnitBrowserControl.class);
	...
	public HtmlUnitBrowserControl(JsonObject config, String testId, TestInstanceEventLog eventLog, TestExecutionManager executionManager, ImageService imageService) {
		super(testId);
	...
	public void goToUrl(String url, String placeholder, String method) {
		...
		for (JsonElement commandsEl : browserCommands) {
			...
			if (PatternMatchUtils.simpleMatch(urlMatcher, url)) {
				...
				WebRunner wr = submitWebRunner(url, placeholder, method, commands);
	...
	@NotNull
	private WebRunner submitWebRunner(String url, String placeholder, String method, JsonObject commands) {
		WebRunner wr = new HtmlUnitWebRunner(url, commands.getAsJsonArray("tasks"), placeholder, method);
	 ...
	 */
	private class HtmlUnitWebRunner extends WebRunner {
		 ...
		 */
		protected HtmlUnitWebRunner(String url, JsonArray tasks, String placeholder, String method) {
