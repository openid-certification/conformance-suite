...
@PublishTestModule(
	testName = "fapi2-baseline-id2-brazil-ensure-encryption-required",
	displayName = "FAPI2-Baseline-ID2: ensure encryption is required when passing request object via browser",
