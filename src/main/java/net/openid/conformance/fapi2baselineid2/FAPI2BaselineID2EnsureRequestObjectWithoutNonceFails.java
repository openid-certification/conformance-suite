...
@PublishTestModule(
	testName = "fapi2-baseline-id2-ensure-request-object-without-nonce-fails",
	displayName = "FAPI2-Baseline-ID2: ensure request object without nonce fails",
...
public class FAPI2BaselineID2EnsureRequestObjectWithoutNonceFails extends AbstractFAPI2BaselineID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
