...
@PublishTestModule(
	testName = "fapi2-baseline-id2-ensure-request-object-with-long-state",
	displayName = "FAPI2-Baseline-ID2: ensure request object with long state",
...
public class FAPI2BaselineID2EnsureRequestObjectWithLongState extends AbstractFAPI2BaselineID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
