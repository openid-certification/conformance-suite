...
@PublishTestModule(
	testName = "fapi2-baseline-id2-ensure-unsigned-request-at-par-endpoint-fails",
	displayName = "FAPI2-Baseline-ID2: ensure unsigned request at PAR endpoint fails",
...
public class FAPI2BaselineID2EnsureUnsignedRequestAtParEndpointFails extends AbstractFAPI2BaselineID2ExpectingAuthorizationEndpointPlaceholderOrCallback {
	...
	protected void createPlaceholder() {
		callAndStopOnFailure(ExpectAuthorizationRequestWithoutRequestObjectErrorPage.class, "FAPI1-ADV-5.2.3-8"); // FIXME
