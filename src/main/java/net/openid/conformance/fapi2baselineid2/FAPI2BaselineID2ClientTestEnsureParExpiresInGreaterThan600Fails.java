...
@PublishTestModule(
	testName = "fapi2-baseline-id2-client-test-ensure-par-expires_in-greater-than-600-fails",
...
public class FAPI2BaselineID2ClientTestEnsureParExpiresInGreaterThan600Fails extends AbstractFAPI2BaselineID2ClientExpectNothingAfterParResponse {


	@Override
	protected void addCustomValuesToParResponse() {
		callAndContinueOnFailure(SetParResponseExpiresInToGreaterThan600.class);
	}
	...
	protected String getParResponseErrorMessage() {
		return "Set PAR response expires_in > 600";
	}
}
