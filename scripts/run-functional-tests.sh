...
TESTS+=('Payments API - INIC/DICT/MANU/QRES/QRDN[client_auth_type=private_key_jwt][fapi_auth_request_method=by_value][fapi_response_mode=plain_response]' ./scripts/configs/generated-payment-config.json)
