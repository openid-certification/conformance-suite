...
config_ignore = [
    ...
    # byte-level snapshot comparison to round-trip on regeneration. Same
    # autogenerated-artefact exemption pattern as vendor/ above.
    'frontend/e2e/schedule-test-baselines.spec.js-snapshots/',
]
