...
makeVcTests() {
    ...
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$HASH][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-minimal-cnf-jwk{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$HASH][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow-no-state}${CONFIGS}/vp-wallet-test-config-dcql-sdjwt.json ${CONFIGS}/vp-verifier-test-config-with-redirect-no-client-id.json"
    ...
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow-no-state}${CONFIGS}/vp-wallet-test-config-dcql-mdoc-mdl.json ${CONFIGS}/vp-verifier-test-config.json"
