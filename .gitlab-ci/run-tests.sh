...
makeServerTest() {
    ...
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-no-mtls.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=mtls
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-mtls-client-auth-dpop.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop - issuer initiated (credential offer by value)
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][$ISSUERINIT][$AUTHCODE][$OFFERBYVALUE]:oid4vci-1_0-wallet-happy-path{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][$ISSUERINIT][$AUTHCODE][$OFFERBYVALUE][vci_credential_issuer_metadata=discovery]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
