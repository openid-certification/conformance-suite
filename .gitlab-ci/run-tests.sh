...
_makeFapiTestPart1() {
    ...
    # FAPI2 message signing - jar + rar + grant management + Chile Open Finance
    TESTS="${TESTS} fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=openbanking_chile][fapi_response_mode=plain_response][authorization_request_type=rar][grant_management=enabled] authlete-fapi2securityprofile-mtls-jar-chile.json"
...
_makeFapiTestPart2() {
    ...
    # FAPI1 happy path where the server does not publish mtls_endpoint_aliases
    # Token is always mTLS-bound regardless of client_auth_type; PAR is mTLS-bound only for
    # mtls client auth, so mtls+pushed exercises both, private_key_jwt+by_value exercises
    # neither, and private_key_jwt+pushed exercises the "PAR stays at the conventional URL" case.
    # Uses a dedicated fapi-op-test-config-no-mtls-endpoint-aliases.json (rather than the plain
    # fapi-op-test-config.json also used by the aliased happy path above with the same OP-side
    # variant+module combination) so compare-results.py can tell the two runs apart - see its
    # "More than one result for" comment.
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_auth_request_method=by_value][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi1-advanced-final-test-plan[client_auth_type=mtls][fapi_auth_request_method=by_value][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_auth_request_method=pushed][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi1-advanced-final-test-plan[client_auth_type=mtls][fapi_auth_request_method=pushed][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_auth_request_method=by_value][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi1-advanced-final-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=by_value][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_auth_request_method=pushed][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi1-advanced-final-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=pushed][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
...
#    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_auth_request_method=pushed][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test{fapi1-advanced-final-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=pushed][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-opin.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-opin.json"
    ...
    # FAPI2 happy path where the server does not publish mtls_endpoint_aliases
    # client_auth=private_key_jwt, sender_constrain=mtls: token/userinfo endpoints are expected
    # at the mTLS root, but PAR (not itself using MTLS client auth) is expected at the plain root.
    # Uses dedicated *-no-mtls-endpoint-aliases.json OP configs (rather than the plain configs
    # also used by the aliased happy path above with the same OP-side variant+module combination)
    # so compare-results.py can tell the two runs apart - see its "More than one result for" comment.
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
    # client_auth=mtls, sender_constrain=dpop: token/PAR expected at the mTLS root (mTLS client
    # auth), userinfo/accounts expected at the plain root (the access token is DPoP-bound, not
    # mTLS-bound).
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path-no-mtls-endpoint-aliases{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-mtls-client-auth-dpop-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"

    # FAPI2 grant management, RP against OP. The RP-side modules are driven by the OP-side grant
    # management modules acting as the client, which is the only reference implementation of the grant
    # management spec available to us.
      # plain_fapi, signed_non_repudiation, plain_response, client_auth=mtls, sender_constrain=mtls
    # happy-path and query-and-revoke are disabled: the client test module ends before the grant management calls arrive, so the driver gets HTTP 400
    #TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-client-test-grant-management-happy-path{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-grant-management-query-and-revoke}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-grant-management-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-grant-management-test-config.json"
    #TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-client-test-grant-management-query-and-revoke{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-grant-management-query-and-revoke}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-grant-management-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-grant-management-test-config.json"
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-client-test-grant-management-invalid-grant-id-fails{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][grant_management=enabled]:fapi2-security-profile-final-grant-management-ensure-invalid-grant-id-fails}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-grant-management-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-grant-management-test-config.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-ed25519-keytest-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-ed25519-keytest-config.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-id2-discovery-end-point-verification,fapi2-security-profile-id2-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-eddsa-keys-certs-mtls.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-eddsa_certs_mtls-config.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-eddsa-keys-certs-mtls.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-eddsa_certs_mtls-config.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=unsigned][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=unsigned][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-par-without-duplicate-parameters}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-jwks.json"
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][fapi_request_method=unsigned][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-client-test-happy-path{fapi2-message-signing-final-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=unsigned][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-par-without-duplicate-parameters}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-mtls-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-jwks.json"
...
makeVcTests() {
    ...
    # the wallet tests' built-in DCQL queries, i.e. configurations with no dcql of their own
    PIDTYPE="credential_type=eudi_pid"
    MDLTYPE="credential_type=mdl"
    PHOTOIDTYPE="credential_type=photoid"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$PIDTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow}${CONFIGS}/vp-wallet-test-config-builtin-pid.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$MDLTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow}${CONFIGS}/vp-wallet-test-config-builtin-mdl.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$PHOTOIDTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow}${CONFIGS}/vp-wallet-test-config-builtin-photoid.json ${CONFIGS}/vp-verifier-test-config.json"
    # the all-mandatory-claims module with each built-in credential type
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$PIDTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-all-mandatory-claims}${CONFIGS}/vp-wallet-test-config-builtin-pid.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$MDLTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-all-mandatory-claims}${CONFIGS}/vp-wallet-test-config-builtin-mdl.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$PHOTOIDTYPE][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-all-mandatory-claims}${CONFIGS}/vp-wallet-test-config-builtin-photoid.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-request-uri-fetched-twice{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow}${CONFIGS}/vp-wallet-test-config-dcql-sdjwt-request-uri-fetched-twice.json ${CONFIGS}/vp-verifier-test-config.json"
    ...
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt]:oid4vp-1final-wallet-ignores-unusable-encryption-key}${CONFIGS}/vp-wallet-test-config-dcql-sdjwt.json ${CONFIGS}/vp-verifier-test-config.json"
    ...
    # photo ID (ISO/IEC TS 23220-4 Annex C) rather than an mDL
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$VPPROFILE][$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow}${CONFIGS}/vp-wallet-test-config-dcql-photoid.json ${CONFIGS}/vp-verifier-test-config.json"
    ...
    TESTS="${TESTS} oid4vci-1_0-wallet-haip-test-plan[$WALLETINIT][$OFFERBYVALUE][$SDJWTVC]:fapi2-security-profile-final-client-test-happy-path{oid4vci-1_0-issuer-haip-test-plan[$WALLETINIT][$SDJWTVC]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-par-without-duplicate-parameters}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
        # FAPI2SP rp-against-op pattern under vci_haip - issuer initiated (credential offer by value / by reference), see #1901.
        # The issuer-side FAPI2SP modules don't consume credential offers, so pair with the VCI issuer happy flow instead.
    TESTS="${TESTS} oid4vci-1_0-wallet-haip-test-plan[$ISSUERINIT][$OFFERBYVALUE][$SDJWTVC]:fapi2-security-profile-final-client-test-happy-path{oid4vci-1_0-issuer-haip-test-plan[$ISSUERINIT][$SDJWTVC]:oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    TESTS="${TESTS} oid4vci-1_0-wallet-haip-test-plan[$ISSUERINIT][$OFFERBYREF][$SDJWTVC]:fapi2-security-profile-final-client-test-happy-path{oid4vci-1_0-issuer-haip-test-plan[$ISSUERINIT][$SDJWTVC]:oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-offer-by-ref.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    ...
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$RAR][$MTLSAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$PREAUTHCODE][$OFFERBYVALUE][$PLAINVCI][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$RAR][$MTLSAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$PREAUTHCODE][$PLAINVCI][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-plain.json"
        # client_auth=mtls, sender_constrain=dpop, grant_type=authorization_code - wallet initiated, RAR variant — exercises the wallet-side authorization_details validators on the auth endpoint
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$RAR][$MTLSAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$PLAINVCI][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$RAR][$MTLSAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$PLAINVCI][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-plain.json"
    ...
    # mdoc mDL credential - exercises the mDL mandatory data elements check
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-mdoc-mdl.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    # photo ID (ISO/IEC TS 23220-4 Annex C) rather than an mDL - uses the dedicated HAIP plans so they get mdoc coverage
    TESTS="${TESTS} oid4vci-1_0-wallet-haip-test-plan[$WALLETINIT][$OFFERBYVALUE][$MDOC]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-haip-test-plan[$WALLETINIT][$MDOC]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-mdoc-photoid.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    # Batch issuance - reversed-order wallet test paired with the issuer-side batch test (sd-jwt and mdoc)
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-batch-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-batch-issuance}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-batch-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-batch-issuance}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-mdoc.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
    # mDL doctype batch issuance - also exercises the mDL mandatory data elements check within a batch
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-batch-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$HAIP][$MDOC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-batch-issuance}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-mdoc-mdl.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config-haip.json"
...
makeCIBATest() {
    ...
    # FAPI CIBA happy path where the server does not publish mtls_endpoint_aliases
    # CIBA has no sender_constrain axis (tokens are always mTLS-bound, and the token endpoint is
    # always called over mTLS regardless of client_auth_type), so only the backchannel endpoint's
    # channel depends on client_auth_type here - resourceUrl is unconditionally the mTLS one, same
    # as the existing fapi-ciba-op-test-config.json used above. The OP config used here is still a
    # dedicated fapi-ciba-op-test-config-no-mtls-endpoint-aliases.json copy, though, since these
    # entries drive the OP side with the exact same variant+module combination as the aliased
    # happy path pairing above - reusing that config's identical description would make
    # compare-results.py unable to tell the two runs apart (see its "More than one result for"
    # comment).
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=mtls][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-test-happy-path-no-mtls-endpoint-aliases{fapi-ciba-id1-test-plan[client_auth_type=mtls][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-discovery-end-point-verification,fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-test-happy-path-no-mtls-endpoint-aliases{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-discovery-end-point-verification,fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config-no-mtls-endpoint-aliases.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"

    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-requested-expiry-as-string-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-valid-aud-as-array-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-authorization-request-with-binding-message-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config-valid-aud.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-no-scope-in-token-endpoint-response-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config-no-scope.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-respects-interval-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=plain_fapi]:fapi-ciba-id1-client-slow-down-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=plain_fapi][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-authorization-request-with-binding-message-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    # ConnectID CIBA OP modules against the suite RP
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=connectid_au]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=connectid_au][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-connectid-ensure-authorization-request-with-purpose-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=connectid_au]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=connectid_au][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-connectid-ensure-authorization-request-with-3ds-card-login-hint-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=poll][fapi_ciba_profile=connectid_au]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=connectid_au][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-connectid-ensure-authorization-request-with-3ds-payment-authorization-details-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-rp-test-config.json"
    # OFBR PKJWT
    ...
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=ping][fapi_ciba_profile=openbanking_brazil]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=openbanking_brazil][ciba_mode=ping][client_registration=static_client]:fapi-ciba-id1-ping-notification-endpoint-retries-after-transient-error-for-brazil}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    ...
    # OFBR two-sided DCR happy path
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=ping][fapi_ciba_profile=openbanking_brazil]:fapi-ciba-id1-client-brazildcr-happypath-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=openbanking_brazil][ciba_mode=ping][client_registration=dynamic_client]:fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config-dcr.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config-dcr.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=ping][fapi_ciba_profile=openbanking_brazil]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=openbanking_brazil][ciba_mode=ping][client_registration=static_client]:fapi-ciba-id1-ensure-requested-expiry-above-maximum-is-capped-for-brazil}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=ping][fapi_ciba_profile=openbanking_brazil]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=openbanking_brazil][ciba_mode=ping][client_registration=static_client]:fapi-ciba-id1-ensure-requested-expiry-as-string-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    # Certless ping: the RP test must pass; the OP driver must record the missing certificate.
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=private_key_jwt][ciba_mode=ping][fapi_ciba_profile=openbanking_brazil]:fapi-ciba-id1-client-ping-without-mtls-certificate-test{fapi-ciba-id1-test-plan[client_auth_type=private_key_jwt][fapi_ciba_profile=openbanking_brazil][ciba_mode=ping][client_registration=static_client]:fapi-ciba-id1-ensure-other-scope-order-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config-certless-ping.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
}
