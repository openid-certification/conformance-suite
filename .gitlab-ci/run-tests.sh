...
makeServerTest() {
    ...
    TESTS="${TESTS} fapi1-advanced-final-test-plan[client_auth_type=private_key_jwt][fapi_profile=consumerdataright_au][fapi_response_mode=plain_response][fapi_auth_request_method=by_value] authlete-fapi1-adv-final-privatekey-encryptedidtoken.json"
    ...
    # VP 1.0 Final
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST][$DCQL]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST][$DCQL]:oid4vp-1final-wallet-happy-flow-no-state}${CONFIGS}/vp-wallet-test-config-dcql.json ${CONFIGS}/vp-verifier-test-config.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-wallet-happy-flow-with-state-and-redirect}${CONFIGS}/vp-wallet-test-config-dcql.json ${CONFIGS}/vp-verifier-test-config-with-redirect.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-wallet-happy-flow-no-state}${CONFIGS}/vp-wallet-test-config-dcql.json ${CONFIGS}/vp-verifier-test-config-with-redirect.json"
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-verifier-happy-flow{oid4vp-1final-wallet-test-plan[$MDL][$SANDNS][$SIGNEDREQ][$DIRECTPOST.jwt][$DCQL]:oid4vp-1final-wallet-happy-flow-with-state-and-redirect}${CONFIGS}/vp-wallet-test-config-dcql.json ${CONFIGS}/vp-verifier-test-config-with-redirect-alt.json"
    ...
    TESTS="${TESTS} oid4vci-id2-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP]:oid4vci-id2-wallet-happy-path{oid4vci-id2-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-id2-issuer-metadata-test,oid4vci-id2-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-id2-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP]:oid4vci-id2-wallet-happy-path{oid4vci-id2-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$PLAINFAPI][$PLAINRESP][vci_credential_issuer_metadata=discovery]:oid4vci-id2-issuer-metadata-test,oid4vci-id2-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-no-mtls.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=mtls
