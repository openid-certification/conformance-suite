...
makeClientTest() {
    ...
    #TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_profile=openbanking_brazil][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_client_type=oidc][brazil_client_scope=openid-payments] automated-brazil-client-test.json"
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][fapi_auth_request_method=pushed][fapi_response_mode=plain_response][fapi_client_type=oidc][brazil_client_scope=openid-payments] automated-brazil-client-test-payments.json"

    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_profile=openbanking_brazil][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_client_type=oidc][brazil_client_scope=openid-accounts] automated-brazil-client-test.json"
    #TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][fapi_auth_request_method=pushed][fapi_response_mode=plain_response][fapi_client_type=oidc][brazil_client_scope=openid-accounts] automated-brazil-client-test.json"

    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_profile=openbanking_brazil][fapi_auth_request_method=by_value][fapi_response_mode=jarm][fapi_client_type=plain_oauth][brazil_client_scope=accounts] automated-brazil-client-test.json"
...
makeServerTest() {
    ...
    TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=mtls][fapi_response_mode=plain_response][fapi_auth_request_method=by_value] authlete-fapi-brazil-dcr.json"
    #TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=private_key_jwt][fapi_response_mode=plain_response][fapi_auth_request_method=by_value] authlete-fapi-brazil-dcr.json"
    #TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=mtls][fapi_response_mode=plain_response][fapi_auth_request_method=pushed] authlete-fapi-brazil-dcr.json"
    ...
    #TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=mtls][fapi_response_mode=jarm][fapi_auth_request_method=by_value] authlete-fapi-brazil-dcr.json"
    TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=private_key_jwt][fapi_response_mode=jarm][fapi_auth_request_method=by_value] authlete-fapi-brazil-dcr.json"
    TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=mtls][fapi_response_mode=jarm][fapi_auth_request_method=pushed] authlete-fapi-brazil-dcr.json"
    #TESTS="${TESTS} fapi1-advanced-final-brazil-dcr-test-plan[fapi_profile=openbanking_brazil][client_auth_type=private_key_jwt][fapi_response_mode=jarm][fapi_auth_request_method=pushed] authlete-fapi-brazil-dcr.json"
    ...
    # Brazil OPIN
    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_auth_request_method=by_value][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test{fapi1-advanced-final-test-plan[client_auth_type=mtls][fapi_auth_request_method=by_value][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-opin.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-opin.json"

    # Brazil DCR (mtls)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=by_value]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=mtls][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-accounts-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-accounts.json"
    # Brazil DCR (mtls+PAR)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=pushed]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=mtls][fapi_auth_request_method=pushed][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-accounts-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-accounts.json"
    # Brazil DCR accounts (private_key_jwt)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=by_value]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-accounts-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-accounts.json"
    # Brazil DCR payments (private_key_jwt)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=by_value]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_profile=openbanking_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-payments-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-payments.json"
    # Brazil DCR OPIN (private_key_jwt)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openinsurance_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=by_value]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_profile=openinsurance_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-opin-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-opin-dcr.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config.json"
    ...
    # FAPI2 Advanced OP against RP using EdDSA signing alg
      # plain_fapi, signed_non_repudiation, plain_response
         # client_auth=private_key, sender_constrain=mtls
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-eddsa-keytest-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-eddsa-keytest-config.json"

         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-eddsa-keytest-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-eddsa-keytest-config.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-idmvp.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-idmvp.json"
    # idmvp returning identity claims
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-idmvp-test-claims-parameter-idtoken-identity-claims}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-idmvp.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-idmvp.json"

    # plain fapi without openid connect
    TESTS="${TESTS} fapi2-message-signing-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=plain_oauth][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-client-test-happy-path{fapi2-message-signing-id1-test-plan[openid=plain_oauth][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-securityprofile-id2-discovery-end-point-verification,fapi2-securityprofile-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-no-openid.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-openid.json"
