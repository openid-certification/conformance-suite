...
makeServerTest() {
    ...
    # FAPI2 advanced
    TESTS="${TESTS} fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=unsigned][sender_constrain=mtls][fapi_response_mode=jarm][fapi_profile=openbanking_brazil] authlete-fapi2baseline-brazil-privatekey-jarm.json"
    # We don't have access to a server that supports 'signed_non_repudiation' yet
    #TESTS="${TESTS} fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=openbanking_brazil] authlete-fapi2baseline-brazil-privatekey.json"
    ...
    # FAPI2 Advanced OP against RP using EdDSA signing alg
      # plain_fapi, signed_non_repudiation, plain_response
         # client_auth=private_key, sender_constrain=mtls
    TESTS="${TESTS} fapi2-advanced-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-client-test-happy-path{fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-discovery-end-point-verification,fapi2-baseline-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-eddsa-keytest-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-eddsa-keytest-config.json"

         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} fapi2-advanced-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-client-test-happy-path{fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-discovery-end-point-verification,fapi2-baseline-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-eddsa-keytest-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-eddsa-keytest-config.json"
    ...
    TESTS="${TESTS} fapi2-advanced-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-baseline-id2-client-test-happy-path{fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-baseline-id2-discovery-end-point-verification,fapi2-baseline-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-idmvp.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-idmvp.json"
    # idmvp returning identity claims
    TESTS="${TESTS} fapi2-advanced-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-baseline-id2-client-test-happy-path{fapi2-advanced-id1-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=idmvp][fapi_response_mode=plain_response]:fapi2-baseline-id2-discovery-end-point-verification,fapi2-baseline-id2-idmvp-test-claims-parameter-idtoken-identity-claims}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-idmvp.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-idmvp.json"

    # plain fapi without openid connect
    TESTS="${TESTS} fapi2-advanced-id1-client-test-plan[client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][fapi_client_type=plain_oauth][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-client-test-happy-path{fapi2-advanced-id1-test-plan[openid=plain_oauth][client_auth_type=private_key_jwt][fapi_request_method=signed_non_repudiation][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:fapi2-baseline-id2-discovery-end-point-verification,fapi2-baseline-id2-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-op-test-config-no-openid.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-openid.json"
