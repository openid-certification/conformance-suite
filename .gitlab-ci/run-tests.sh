...
makeVcTests() {
    ...
    # Authorization Code Flow
         # client_auth=private_key, sender_constrain=mtls
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
         # client_auth=private_key, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$DPOP][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-no-mtls.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=mtls
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$DPOP][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$MTLSAUTH][$UNSIGNED][$DPOP][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop key-attestation
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-key-attestation.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop - issuer initiated (credential offer by value)
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop - issuer initiated (credential offer by reference)
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYREF][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYREF][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
