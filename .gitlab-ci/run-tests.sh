...
function makeServerTest {
    ...
    TESTS="${TESTS} fapi-rw-id2-ob-with-mtls-test-plan:openbankinguk-mtls authlete-fapi-rw-id2-ob-mtls.json"
    TESTS="${TESTS} fapi-rw-id2-ob-with-private-key-and-mtls-holder-of-key-test-plan:openbankinguk-private_key_jwt authlete-fapi-rw-id2-ob-privatekey.json"
    ...
    # authlete FAPI
    TESTS="${TESTS} fapi-rw-id2-with-mtls-test-plan:mtls authlete-fapi-rw-id2-mtls.json"
    TESTS="${TESTS} fapi-rw-id2-with-private-key-and-mtls-holder-of-key-test-plan:private_key_jwt authlete-fapi-rw-id2-privatekey.json"
    ...
    TESTS="${TESTS} fapi-rw-id2-with-private-key-and-mtls-holder-of-key-test-plan:private_key_jwt authlete-fapi-rw-id2-privatekey-for-instructions.json"
}
