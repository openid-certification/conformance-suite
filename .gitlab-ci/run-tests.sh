...
makeServerTest() {
    ...
    # Brazil DCR OPIN (mtls)
    TESTS="${TESTS} fapi1-advanced-final-brazil-client-test-plan[client_auth_type=mtls][fapi_client_type=oidc][fapi_response_mode=plain_response][fapi_profile=openinsurance_brazil]:fapi1-advanced-final-client-brazildcr-happypath-test[fapi_auth_request_method=by_value]{fapi1-advanced-final-brazil-dcr-test-plan[client_auth_type=mtls][fapi_auth_request_method=by_value][fapi_response_mode=plain_response][fapi_profile=openinsurance_brazil]:fapi1-advanced-final-brazildcr-happy-flow}../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-opin-dcr.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-opin-dcr.json"
...
makeCIBATest() {
    ...
    # OFBR MTLS
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=mtls][ciba_mode=poll][fapi_profile=openbanking_brazil]:fapi-ciba-id1-client-test{fapi-ciba-id1-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-discovery-end-point-verification,fapi-ciba-id1-ensure-other-scope-order-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=mtls][ciba_mode=poll][fapi_profile=openbanking_brazil]:fapi-ciba-id1-client-refresh-token-test{fapi-ciba-id1-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-ensure-other-scope-order-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=mtls][ciba_mode=poll][fapi_profile=openbanking_brazil]:fapi-ciba-id1-client-access-denied-test{fapi-ciba-id1-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-user-rejects-authentication}../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    TESTS="${TESTS} fapi-ciba-id1-client-test-plan[client_auth_type=mtls][ciba_mode=poll][fapi_profile=openbanking_brazil]:fapi-ciba-id1-client-invalid-request-test{fapi-ciba-id1-test-plan[client_auth_type=mtls][fapi_profile=openbanking_brazil][ciba_mode=poll][client_registration=static_client]:fapi-ciba-id1-multiple-call-to-token-endpoint}../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-op-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/fapi-ciba-brazil-rp-test-config.json"
    # OFBR PKJWT
