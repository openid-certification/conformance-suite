...
makeServerTest() {
    ...
    TESTS="${TESTS} oid4vci-id2-wallet-test-plan[client_auth_type=private_key_jwt][fapi_request_method=unsigned][fapi_client_type=oidc][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:oid4vci-id2-wallet-happy-path{oid4vci-id2-issuer-test-plan[openid=openid_connect][client_auth_type=private_key_jwt][fapi_request_method=unsigned][sender_constrain=dpop][fapi_profile=plain_fapi][fapi_response_mode=plain_response][vci_credential_issuer_metadata=discovery]:oid4vci-id2-issuer-metadata-test,oid4vci-id2-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config-no-mtls.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=mtls
    TESTS="${TESTS} oid4vci-id2-wallet-test-plan[client_auth_type=mtls][fapi_request_method=unsigned][fapi_client_type=oidc][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response]:oid4vci-id2-wallet-happy-path{oid4vci-id2-issuer-test-plan[openid=openid_connect][client_auth_type=mtls][fapi_request_method=unsigned][sender_constrain=mtls][fapi_profile=plain_fapi][fapi_response_mode=plain_response][vci_credential_issuer_metadata=discovery]:oid4vci-id2-issuer-metadata-test,oid4vci-id2-issuer-ensure-request-object-with-multiple-aud-succeeds}../conformance-suite/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ../conformance-suite/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=mtls, sender_constrain=dpop
