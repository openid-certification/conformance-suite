...
makeVcTests() {
    ...
    TESTS="${TESTS} oid4vp-1final-verifier-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-verifier-invalid-kb-jwt-signature{oid4vp-1final-wallet-test-plan[$VPPROFILE][$SDJWT][$SANDNS][$SIGNEDREQ][$DIRECTPOST]:oid4vp-1final-wallet-happy-flow-no-state}${CONFIGS}/vp-wallet-test-config-dcql-sdjwt-negative.json ${CONFIGS}/vp-verifier-test-config.json"
    ...
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$WALLETINIT][$AUTHCODE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
    ...
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYVALUE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
        # client_auth=client_attestation, sender_constrain=dpop - issuer initiated (credential offer by reference)
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$OFFERBYREF][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$CLIATTAUTH][$UNSIGNED][$DPOP][$ISSUERINIT][$AUTHCODE][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config-client_attestation-client-auth-dpop-offer-by-ref.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
