...
makeServerTest() {
    ...
    #TESTS="${TESTS} fapi2-security-profile-final-client-credentials-grant-test-plan[client_auth_type=private_key_jwt][sender_constrain=dpop] authlete-fapi2securityprofile-brazil-privatekey-dpop-aldo.json"
