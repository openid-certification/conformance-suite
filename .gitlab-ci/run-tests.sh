...
#    TESTS="${TESTS} fapi1-advanced-final-client-test-plan[client_auth_type=private_key_jwt][fapi_client_type=oidc][fapi_auth_request_method=pushed][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-client-test{fapi1-advanced-final-test-plan[client_auth_type=private_key_jwt][fapi_auth_request_method=pushed][fapi_profile=openinsurance_brazil][fapi_response_mode=plain_response]:fapi1-advanced-final-ensure-request-object-with-multiple-aud-succeeds}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-brazil-op-test-config-opin.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-brazil-rp-test-config-opin.json"
    ...
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=private_key_jwt][sender_constrain=mtls][fapi_profile=fapi_client_credentials_grant][fapi_response_mode=plain_response][fapi_request_method=unsigned][fapi_client_type=plain_oauth]:fapi2-security-profile-final-client-test-happy-path{fapi2-security-profile-final-test-plan[openid=plain_oauth][client_auth_type=private_key_jwt][sender_constrain=mtls][fapi_profile=fapi_client_credentials_grant]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-access-token-type-header-case-sensitivity}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-no-openid.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-openid.json"

    # FAPI2 Advanced OP against RP
      # fapi_client_credentials_grant, unsigned, plain_response
         # client_auth=mtls, sender_constrain=dpop
    TESTS="${TESTS} fapi2-message-signing-final-client-test-plan[client_auth_type=mtls][sender_constrain=dpop][fapi_profile=fapi_client_credentials_grant][fapi_response_mode=plain_response][fapi_request_method=unsigned][fapi_client_type=plain_oauth]:fapi2-security-profile-final-client-test-happy-path-no-dpop-nonce{fapi2-security-profile-final-test-plan[openid=plain_oauth][client_auth_type=mtls][sender_constrain=dpop][fapi_profile=fapi_client_credentials_grant]:fapi2-security-profile-final-discovery-end-point-verification,fapi2-security-profile-final-access-token-type-header-case-sensitivity}${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-op-test-config-dpop-no-openid.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/fapi-rp-test-config-no-openid.json"
...
makeVcTests() {
    ...
    # Authorization Code Flow
         # client_auth=private_key, sender_constrain=mtls
    TESTS="${TESTS} oid4vci-1_0-wallet-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$ISSUANCE_IMMEDIATE]:oid4vci-1_0-wallet-test-credential-issuance{oid4vci-1_0-issuer-test-plan[$SIMPLE][$PRIVATE_KEY][$UNSIGNED][$MTLSAT][$HAIP][$SDJWTVC][$CRED_RESP_ENCR_PLAIN][$FAPI_OPENID][$FAPI_RESPONSEMODE]:oid4vci-1_0-issuer-metadata-test,oid4vci-1_0-issuer-happy-flow}${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-issuer-test-config.json ${SUITE_DIR}/scripts/test-configs-rp-against-op/vci-wallet-test-config.json"
         # client_auth=private_key, sender_constrain=dpop
